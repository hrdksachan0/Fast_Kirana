# Graph Report - Fastkirana  (2026-09-13)

## Corpus Check
- 813 files · ~3,229,588 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7938 nodes · 13797 edges · 381 communities (306 shown, 75 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 350 edges (avg confidence: 0.52)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `330a12a9`
...
## Communities (381 total, 75 thin omitted)

### Community 0 - "package:flutter/material.dart"
Cohesion: 0.03
Nodes (78): ../cafe/restaurant_dashboard.dart, ../core/theme/design_system.dart, delivery_dashboard.dart, AboutScreen, build, _divider, _linkItem, _statBox (+70 more)
...
### Community 3 - "auth"
Cohesion: 0.04
Nodes (68): WishlistPage(), EditRestaurantPage(), NewRestaurantPage(), DELETE(), GET(), PATCH(), POST(), PUT() (+60 more)
...
### Community 5 - "cn"
Cohesion: 0.04
Nodes (58): getRoleRedirect(), LoginForm(), RootLayout(), iconMap, ProductPage(), ProductPageProps, revalidate, AccountDashboard() (+50 more)

### Community 6 - "api/orders/route.ts"
Cohesion: 0.05
Nodes (48): AdminRestaurantsPage(), revalidate, checkAdmin(), GET(), PATCH(), POST(), GET(), POST() (+40 more)
...
### Community 8 - "date-helpers.ts"
Cohesion: 0.05
Nodes (45): DeliveryHeader(), DeliveryHeaderProps, LiveClock(), OrderConfirmPage(), OrderConfirmPageProps, AdminAlerts(), AdminAlertsProps, AlertItem (+37 more)

### Community 9 - "category_products_screen.dart"
Cohesion: 0.06
Nodes (36): ../../core/widgets/loading_widgets.dart, ../data/models/product.dart, ../data/repositories/product_repository.dart, _buildFilterPill, category, createState, dispose, emoji (+28 more)

### Community 10 - "cart_screen.dart"
Cohesion: 0.06
...
Cohesion: 0.04
Nodes (83): CategoriesScreen, ConsumerState, ConsumerStatefulWidget, DeliveryLoginScreen, bootstrapUserLocation, LocationService, AdminLoginScreen, _AdminLoginScreenState (+75 more)

### Community 15 - "profile_screen.dart"
Cohesion: 0.03
Nodes (62): address_book_screen.dart, ../auth/login_screen.dart, ../../../core/services/battery_optimization_service.dart, ../core/utils/dish_timing.dart, ../../data/repositories/auth_repository.dart, build, _buildTncSection, createState (+54 more)

### Community 16 - "package:flutter_riverpod/flutter_riverpod.dart"
Cohesion: 0.03
Nodes (82): ../core/services/location_service.dart, ../data/models/address.dart, autoFetchLocation, _checkAndAutoPromptLocation, createState, dispose, _getAddressIcon, _handleBack (+74 more)
...
Cohesion: 0.08
Nodes (29): AdminPage(), revalidate, GET(), GET(), revalidate, SuperAdminPage(), authConfig, googleClientId (+21 more)

### Community 24 - "api/products/route.ts"
Cohesion: 0.08
Nodes (32): GET(), GET(), POST(), GET(), POST(), DELETE(), PATCH(), GET() (+24 more)
...
Cohesion: 0.06
Nodes (28): AdminBanners(), AdminBannersProps, FESTIVAL_TEMPLATES, GRADIENT_PRESETS, INSTAMART_PRO_DESIGNS, PromoBanner, AdminSettings(), AdminSettingsProps (+20 more)
...
Cohesion: 0.04
Nodes (62): ConsumerWidget, FadeSlideRoute, deliveryTierProvider, _loadSettings, _buildAdminOrderCard, _handleContinue, _buildDishAddButton, _buildMenuTab (+54 more)

### Community 32 - "home_screen.dart"
Cohesion: 0.03
Nodes (84): , ../categories/category_products_screen.dart, build, build, build, CategoryProductsScreen, _CategoryProductsScreenState, build (+76 more)
...
### Community 35 - "live_clock_badge.dart"
Cohesion: 0.13
...
Cohesion: 0.02
Nodes (95): ../common/widgets/battery_optimization_dialog.dart, ../../core/services/offline_sync_service.dart, ../../core/services/order_alarm_service.dart, ../delivery/widgets/connectivity_banner.dart, dioProvider, AdminOrdersScreen, _AdminOrdersScreenState, _allOrders (+87 more)
...
Cohesion: 0.07
Nodes (27): @base-ui/react, bcryptjs, clsx, date-fns, next, dependencies, @base-ui/react, bcryptjs (+19 more)
...
Cohesion: 0.13
Nodes (19): POST(), POST(), POST(), GET(), POST(), POST(), POST(), POST() (+11 more)
...
### Community 43 - "otp_screen.dart"
Cohesion: 0.03
Nodes (68): ../admin/admin_dashboard.dart, ../categories/categories_screen.dart, ../core/services/secure_storage_service.dart, ../delivery/delivery_dashboard.dart, ../delivery/picker_dashboard.dart, build, createState, dispose (+60 more)
...
Cohesion: 0.05
Nodes (42): doorstep_details_screen.dart, _areaName, _AreaSearchModal, _AreaSearchModalState, build, _calculateDistance, createState, currentArea (+34 more)
...
Cohesion: 0.08
Nodes (34): computeNewValue(), DELETE(), generateBatchId(), GET(), POST(), PATCH(), DELETE(), PATCH() (+26 more)
...
Cohesion: 0.04
Nodes (50): ../data/models/store_hub.dart, area, baseFee, cart, city, deliveryFee, DeliveryTierInfo, distanceKm (+42 more)

### Community 79 - "dynamic_hero_banner_carousel.dart"
Cohesion: 0.04
Nodes (52): category_products_screen.dart, ../core/routes/page_transitions.dart, ../data/models/category.dart, ../data/models/restaurant.dart, build, _categories, CategoriesScreen, build (+44 more)
...
### Community 90 - "grocery_delivery_loading_screen.dart"
Cohesion: 0.07
...
### Community 98 - "brand_button.dart"
Cohesion: 0.05
Nodes (40): BorderRadius?, Color?, EdgeInsets?, badgeColor, build, child, onTap, textColor (+32 more)

### Community 99 - "../core/network/api_client.dart"
Cohesion: 0.05
Nodes (44): ../core/network/api_client.dart, ../data/repositories/coupon_repository.dart, ../data/repositories/wishlist_repository.dart, Dio, CouponRepository, dio, getCoupons, ProductRepository (+36 more)

### Community 100 - "admin-dashboard.tsx"
Cohesion: 0.02
Nodes (88): AdminAnalytics(), AdminAnalyticsProps, Category, Order, Product, AdminDashboardProps, BlockCustomerModal, CategoryEditModal (+80 more)
...
### Community 104 - "order_repository.dart"
Cohesion: 0.12
...
Cohesion: 0.04
Nodes (47): AppLinks, bool get, Connectivity, ../core/utils/app_connectivity.dart, dart:async, dart:math, NetworkRetryHelper, _appLinks (+39 more)
...
Cohesion: 0.06
Nodes (81): POST(), CartPage(), Error(), jakarta, metadata, viewport, WishlistClient(), WishlistItem (+73 more)
...
### Community 113 - "State"
Cohesion: 0.11
Nodes (29): ContextualBrandTransitionScreen, _ContextualBrandTransitionScreenState, AdminCouponsDetailScreen, _AdminCouponsDetailScreenState, SplashScreen, _SplashScreenState, RestaurantDeliveryLoadingScreen, _RestaurantDeliveryLoadingScreenState (+21 more)
...
### Community 117 - "checkStoreOperatingStatus"
Cohesion: 0.10
...
Cohesion: 0.04
Nodes (52): ConfettiController, ../data/repositories/order_repository.dart, _animController, _buildDetailRow, _buildProgressLine, _buildProgressStep, _buttonsFadeAnim, _buttonsSlideAnim (+44 more)
...
### Community 132 - "app_update_dialog.dart"
Cohesion: 0.07
Nodes (25): ../core/config/app_config.dart, ../data/models/store_settings.dart, build, _buildCard, _buildParagraph, _buildSection, _bullet, _effectiveDate (+17 more)
...
Cohesion: 0.07
Nodes (25): core/routes/app_router.dart, core/services/deep_link_service.dart, ../core/services/notification_service.dart, ../core/services/supabase_service.dart, core/theme/app_theme.dart, build, _contentFade, createState (+17 more)

### Community 141 - "constants.ts"
Cohesion: 0.05
Nodes (42): AdminDashboard(), AdminRestaurantConsole(), AdminRestaurantConsoleProps, Product, Category, Product, RestaurantCatalogManager(), RestaurantCatalogManagerProps (+34 more)
...
Cohesion: 0.08
Nodes (22): ../data/models/banner.dart, ../data/repositories/banner_repository.dart, design_system.dart, AppTheme, _pageTransitionsTheme, BannerRepository, defaultBanners, dio (+14 more)
...
### Community 153 - "restaurant_sales_report_tab.dart"
Cohesion: 0.11
...
### Community 157 - "add_item_search_sheet.dart"
Cohesion: 0.09
...
Cohesion: 0.09
Nodes (26): POST(), dynamic, GET(), POST(), dynamic, GET(), dynamic, GET() (+18 more)
...
Cohesion: 0.05
Nodes (35): ../cart/cart_screen.dart, build, _buildBillRow, _buildStatusHeaderCard, _buildTimelineStep, _getStatusBg, _getStatusColor, _getStatusStepIndex (+27 more)
...
### Community 233 - "floating_order_tracking_bar.dart"
Cohesion: 0.14
Nodes (16): build, ordersProvider, build, bottomOffset, build, createState, dispose, FloatingOrderTrackingBar (+8 more)
...
### Community 262 - "../../core/services/logger_service.dart"
Cohesion: 0.06
Nodes (31): ../../core/services/logger_service.dart, clearCache, createAddress, defaultAddressWithPhone, defaultGhatampurAddress, deleteAddress, dio, getAddresses (+23 more)
...
### Community 298 - "biometric_service.dart"
Cohesion: 0.25
...
### Community 299 - "bannersProvider"
Cohesion: 0.29
Nodes (7): build, OrderTrackingScreen, _OrderTrackingScreenState, bannersProvider, _advanceToNext, build, _goToPrevious
...
### Community 302 - "push-notifications-tab.tsx"
Cohesion: 0.40
...
### Community 312 - "restaurant_menu_catalog_tab.dart"
Cohesion: 0.06
Nodes (30): cart_conflict_dialog.dart, ../core/utils/restaurant_utils.dart, bgMain, brandGreen, build, _buildMenuFilterChip, createState, dispose (+22 more)
...
Cohesion: 0.02
Nodes (100): BoxShape, DishTimingStatus, double?, AppShimmer, build, child, count, OrderCardShimmer (+92 more)
...
### Community 334 - "get_picker_orders"
Cohesion: 0.40
...
Cohesion: 0.03
Nodes (101): CheckoutCouponInput(), CouponInputProps, CheckoutDeliverySelector(), DeliverySelectorProps, CheckoutOrderSummary(), OrderSummaryProps, ActiveDeliveryCard(), ActiveDeliveryCardProps (+93 more)

### Community 337 - "app/routers/banners.py"
Cohesion: 0.28
Nodes (6): PromoBanner, Base, get_banners(), get, PromoBannerOut, BaseModel

### Community 340 - "Android platform"
Cohesion: 0.29
Nodes (7): Android platform, Color & theming, Components & motion, Layout & structure, The Android slop test, Touch targets, Typography

### Community 341 - "Impeccable Finish Reviewer"
Cohesion: 0.29
...
### Community 388 - "auth_provider.dart"
Cohesion: 0.07
...
## Knowledge Gaps
- **4386 isolated node(s):** `$schema`, `style`, `rsc`, `tsx`, `config` (+4381 more)
...
- **Why does `dependencies` connect `dependencies` to `fcm.py`, `libphonenumber-js`, `react-dom`, `@upstash/redis`, `dotenv`, `@auth/prisma-adapter`, `class-variance-authority`, `scripts`, `lru-cache`, `next-auth`, `framer-motion`, `pg`, `sharp`, `sonner`, `papaparse`, `nodemailer`, `@tailwindcss/postcss`, `@supabase/supabase-js`, `tailwind-merge`, `tailwindcss`, `lucide-react`, `@types/pg`, `@types/react`, `prisma`, `@types/react-dom`, `@prisma/client`, `resend`, `@types/web-push`, `web-push`, `xlsx`, `zustand`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `firebase-admin` connect `fcm.py` to `dependencies`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **What connects `$schema`, `style`, `rsc` to the rest of the system?**
  _4386 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `package:flutter/material.dart` be split into smaller, more focused modules?**
  _Cohesion score 0.029292929292929294 - nodes in this community are weakly interconnected._
...
- **Should `prisma.ts` be split into smaller, more focused modules?**
  _Cohesion score 0.03760330578512397 - nodes in this community are weakly interconnected._
- **Should `auth` be split into smaller, more focused modules?**
  _Cohesion score 0.03729123770304278 - nodes in this community are weakly interconnected._