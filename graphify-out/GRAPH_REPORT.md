...
## Corpus Check
- 1053 files · ~3,488,015 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 10164 nodes · 18283 edges · 463 communities (382 shown, 81 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 631 edges (avg confidence: 0.52)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c1468437`
...
## Communities (463 total, 81 thin omitted)

### Community 0 - "package:flutter/material.dart"
Cohesion: 0.02
Nodes (100): ../../../core/services/battery_optimization_service.dart, ../core/theme/design_system.dart, AboutScreen, build, _divider, _linkItem, _statBox, AdminBannersScreen (+92 more)

### Community 1 - "User"
Cohesion: 0.04
Nodes (145): Banner, Coupon, PromoBanner, RestaurantPayout, User, admin_block_user(), admin_bulk_sort_products(), admin_bulk_update() (+137 more)

### Community 2 - "cart_repository.dart"
Cohesion: 0.05
...
### Community 3 - "VoidCallback?"
Cohesion: 0.05
Nodes (41): AddressCard, build, fullAddress, isSelected, label, onTap, actionLabel, build (+33 more)
...
Cohesion: 0.04
Nodes (70): dynamic, revalidate, CategoryPage(), CategoryPageProps, revalidate, getCachedAllGroceryProducts, getCachedBanners, getCachedBestSellers (+62 more)
...
### Community 7 - "Map"
Cohesion: 0.04
Nodes (47): dart:math, bestTokenFuzzyDistance, damerauLevenshtein, FuzzyMatcher, isFuzzyMatch, similarityScore, build, CartBogoFreeGiftCard (+39 more)

### Community 8 - "_CafeMenuScreenState"
Cohesion: 0.29
...
Cohesion: 0.07
Nodes (38): BinPlacementAlert(), BinPlacementAlertProps, CameraScannerOverlay(), CameraScannerOverlayProps, EditableGroceryProduct, EditProductPriceModal(), EditProductPriceModalProps, MultiOrderConsole() (+30 more)
...
### Community 12 - "cn"
Cohesion: 0.05
Nodes (62): RootLayout(), iconMap, ProductPageProps, revalidate, AccountDashboardProps, RestaurantManager(), RestaurantManagerProps, CheckoutAddressForm() (+54 more)
...
### Community 14 - "api/products/[id]/route.ts"
Cohesion: 0.07
Nodes (34): GET(), GET(), PATCH(), POST(), DELETE(), PATCH(), GET(), PATCH() (+26 more)

### Community 15 - "api/products/route.ts"
Cohesion: 0.10
Nodes (22): GET(), GET(), GET(), getFuzzyScore(), getLevenshteinDistance(), SEARCH_STOP_WORDS, SYNONYM_DICTIONARY, DEFAULT_CAFE_SECTIONS (+14 more)
...
### Community 17 - "add_picker_product_modal.dart"
Cohesion: 0.07
...
Cohesion: 0.13
Nodes (15): ../../admin/vendor_console_screen.dart, build, createState, dispose, _errorMessage, _handleVendorLogin, _isLoading, _phoneOrCodeController (+7 more)
...
### Community 24 - "tracking_map_view.dart"
Cohesion: 0.06
...
Cohesion: 0.04
Nodes (45): CFPaymentGatewayService, _cfService, completeOrderPlacement, _cookingInstruction, copyWith, _couponCode, _currentContext, _customDeliveryNotes (+37 more)
...
### Community 27 - "verify_otp"
Cohesion: 0.09
Nodes (35): bridge_session(), check_email(), direct_login(), DirectLoginRequest, EmailCheckRequest, get_me(), get_session(), google_auth() (+27 more)

### Community 28 - "order_edit_modal.dart"
Cohesion: 0.02
Nodes (93): cart_conflict_dialog.dart, ../data/models/store_settings.dart, _loadSettings, build, brandAmber, brandGreen, build, _calculateSubtotal (+85 more)
...
### Community 30 - "home_category_toggle.dart"
Cohesion: 0.11
Nodes (18): , build, _burgerSvg, createState, dispose, filter, _grocerySvg, HomeCategoryToggle (+10 more)

### Community 31 - "auth_provider.dart"
Cohesion: 0.06
Nodes (34): cart_provider.dart, core/routes/app_router.dart, core/services/deep_link_service.dart, ../core/services/notification_service.dart, ../core/services/secure_storage_service.dart, ../core/services/supabase_service.dart, core/theme/app_theme.dart, build (+26 more)

### Community 32 - "validation.ts"
Cohesion: 0.05
Nodes (49): DELETE(), GET(), PATCH(), POST(), PUT(), resolveUserId(), POST(), POST() (+41 more)
...
### Community 35 - "Order"
Cohesion: 0.04
Nodes (107): Order, OrderStatus, OrderType, PaymentMethod, PaymentStatus, str, Role, admin_sync_razorpay_order() (+99 more)
...
### Community 41 - "dioProvider"
Cohesion: 0.04
Nodes (56): AutomaticKeepAliveClientMixin, dioProvider, _handleLogout, AdminOrdersScreen, _AdminOrdersScreenState, _assignRider, _convertToCOD, _fetchAdminOrders (+48 more)
...
### Community 43 - "delivery_header.dart"
Cohesion: 0.07
...
Cohesion: 0.05
Nodes (94): CartPage(), jakarta, metadata, viewport, WishlistClient(), WishlistItem, CartConflictDialog(), CartDrawer() (+86 more)
...
Cohesion: 0.02
Nodes (103): ../../admin/admin_dashboard.dart, ../../cafe/restaurant_dashboard.dart, ../categories/categories_screen.dart, ../core/network/api_client.dart, ../data/models/user.dart, ../../../data/repositories/auth_repository.dart, ../../delivery/delivery_dashboard.dart, ../../delivery/picker_dashboard.dart (+95 more)
...
Cohesion: 0.05
Nodes (39): AudioPlayer, bool get, Connectivity, dart:async, NetworkRetryHelper, CustomerSoundService, dispose, _initPlayer (+31 more)

### Community 66 - "create_order"
Cohesion: 0.06
Nodes (58): FcmToken, OrderItem, StoreSetting, admin_update_order_status(), BackgroundTasks, Request, Dispatch push notification to one or multiple FCM tokens using Firebase Admin…, send_fcm_notification() (+50 more)
...
### Community 79 - "package:flutter_bounceable/flutter_bounceable.dart"
Cohesion: 0.04
Nodes (49): ../data/models/store_hub.dart, RestaurantPrepTimeModal, show, createState, dispose, _homeScrollController, _isGrocerySelected, _isLoadingMoreGrid (+41 more)

### Community 80 - "routers/auth.py"
Cohesion: 0.09
Nodes (22): FastAPI, Database initialization script. Run with: python init_db.py, Any, Require authenticated user. Raises 401 if not authenticated., Require delivery role (ADMIN or DELIVERY)., require_admin(), require_auth(), require_delivery() (+14 more)

### Community 81 - "use-admin-realtime.ts"
Cohesion: 0.19
Nodes (8): getAudioContext(), useAdminRealtime(), UseAdminRealtimeProps, fastApi, FastApiClient, FastApiOptions, getAuthToken(), getCookie()
...
### Community 86 - "restaurant_menu_catalog_tab.dart"
Cohesion: 0.04
Nodes (42): ../coupons_screen.dart, bgMain, brandGreen, build, _buildMenuFilterChip, createState, dispose, menuItems (+34 more)

### Community 87 - "checkStoreOperatingStatus"
Cohesion: 0.07
Nodes (42): PATCH(), POST(), DELETE(), GET(), PATCH(), GET(), POST(), buildSettingsMap() (+34 more)
...
Cohesion: 0.06
Nodes (62): Product, StoreInventory, admin_bulk_import_products(), admin_create_product(), admin_inward_stock(), Product, Record inward stock / GRN batch. Supports both single batch registration and…, Create a new product. (+54 more)

### Community 91 - "api/orders/route.ts"
Cohesion: 0.07
Nodes (49): AdminPage(), revalidate, POST(), GET(), GET(), POST(), GET(), POST() (+41 more)
...
Cohesion: 0.04
Nodes (46): AdminDashboard(), AdminDashboardProps, BlockCustomerModal, CategoryEditModal, CreateOrderModal, MediaLibraryModal, ReviewEditModal, TabType (+38 more)

### Community 101 - "High-Agency Frontend Skill"
Cohesion: 0.06
Nodes (30): 10. FINAL PRE-FLIGHT CHECK, 1. ACTIVE BASELINE CONFIGURATION, 2. DEFAULT ARCHITECTURE & CONVENTIONS, 3. DESIGN ENGINEERING DIRECTIVES (Bias Correction), 4. CREATIVE PROACTIVITY (Anti-Slop Implementation), 5. PERFORMANCE GUARDRAILS, 6. TECHNICAL REFERENCE (Dial Definitions), 7. AI TELLS (Forbidden Patterns) (+22 more)

### Community 102 - "date-helpers.ts"
Cohesion: 0.05
Nodes (46): CheckoutDeliverySelector(), DeliverySelectorProps, HandoverConfirmModal(), HandoverConfirmModalProps, BogoCartGiftCard(), BogoCartGiftCardProps, EmptyCartScreen(), InventoryIssueScreen() (+38 more)

### Community 103 - "cartProvider"
Cohesion: 0.03
Nodes (89): ../cart/cart_screen.dart, ../../checkout/checkout_screen.dart, ConsumerWidget, ../core/utils/dish_timing.dart, AdminOrderCard, build, _buildCartErrorState, appliedCoupon (+81 more)

### Community 104 - "checkout.ts"
Cohesion: 0.05
Nodes (56): GET(), CheckoutPage(), Address, CreateOrderModalProps, CustomerUser, Product, SelectedItem, FinanceSettingsSection() (+48 more)

### Community 105 - "models.py"
Cohesion: 0.05
Nodes (65): Address, Cart, CashDepositTransaction, DarkStore, InventoryLog, PayoutRequest, PriceHistory, ProductBatch (+57 more)
...
### Community 110 - "send_otp"
Cohesion: 0.13
Nodes (31): OtpToken, generate_otp(), normalize_phone(), OTPRequest, Strip non-digits, keep last 10 digits., Send OTP using Meta WhatsApp Cloud API., Send OTP using Fast2SMS (or any SMS provider)., Send real OTP to phone number via WhatsApp Cloud API or Fast2SMS. Also syncs to… (+23 more)

### Community 111 - "websockets.py"
Cohesion: 0.08
Nodes (37): accept_batch_orders(), confirm_doorstep_qr_payment(), get_delivery_orders(), get_doorstep_qr(), get_rider_delivery_location(), get_rider_wallet(), haversine_km(), Any (+29 more)
...
### Community 114 - "List"
Cohesion: 0.03
Nodes (86): CartItem, ../../categories/category_products_screen.dart, category_products_screen.dart, ../core/routes/page_transitions.dart, ../../../core/widgets/app_cached_image.dart, ../data/models/cart.dart, ../data/models/category.dart, CachedMapTileProvider (+78 more)
...
Cohesion: 0.14
Nodes (22): POST(), POST(), POST(), POST(), GET(), POST(), POST(), POST() (+14 more)
...
### Community 121 - "location-picker.tsx"
Cohesion: 0.13
...
### Community 133 - "storefront-client.tsx"
Cohesion: 0.05
Nodes (48): CUISINES, FoodMarketplace(), FoodMarketplaceProps, SortOption, BrandCardItem, CuratedBrandOffersCarousel(), DealsCurationHub(), DealsCurationHubProps (+40 more)
...
### Community 136 - "push_notify_bridge"
Cohesion: 0.22
...
Cohesion: 0.03
Nodes (64): address_book_screen.dart, ../../auth/login_screen.dart, ../../core/services/admin_notification_service.dart, AdminShareSheet, _buildShareOptionTile, show, build, HomeBuyAgainShelf (+56 more)
...
### Community 141 - "category_products_screen.dart"
Cohesion: 0.03
Nodes (75): ../core/utils/restaurant_utils.dart, ../data/models/product.dart, ../data/repositories/product_repository.dart, ProductRepository, _buildFilterPill, category, createState, dispose (+67 more)
...
### Community 150 - "offline_banner.dart"
Cohesion: 0.14
...
### Community 153 - "cart_bill_details_card.dart"
Cohesion: 0.07
Nodes (27): build, isUpdating, onAcceptAndCook, onEditOrder, onMarkReady, onPrintKot, onReject, order (+19 more)
...
Cohesion: 0.04
Nodes (63): BoxShape, EdgeInsets, AppShimmer, build, child, count, OrderCardShimmer, ProductCardShimmer (+55 more)
...
Cohesion: 0.08
Nodes (32): ../data/repositories/restaurant_repository.dart, build, build, _RestaurantsListScreenState, address, cuisine, distanceMeters, filteredRestaurantsProvider (+24 more)

### Community 173 - "banner_repository.dart"
Cohesion: 0.09
...
Cohesion: 0.01
Nodes (203): Address?, ../core/services/location_service.dart, ../data/models/address.dart, ../data/repositories/address_repository.dart, FadeSlideRoute, area, baseFee, bootstrapUserLocation (+195 more)
...
Cohesion: 0.07
Nodes (24): checkDishTimeAvailability, DishTimingStatus, formattedTimeSlot, formatTime12h, isAvailableNow, nextAvailableTimeStr, build, child (+16 more)
...
### Community 196 - "delivery/page.tsx"
Cohesion: 0.05
Nodes (52): CodPaymentModal(), CodPaymentModalProps, ModalStep, RiderWalletView(), RiderWalletViewProps, UpiQrModal(), loadQrData(), UpiQrModalProps (+44 more)
...
### Community 228 - "cashfree_router.py"
Cohesion: 0.22
...
Cohesion: 0.04
Nodes (54): ../core/config/app_config.dart, ../core/theme/responsive.dart, ../data/models/order.dart, AdminNotificationService, fireAdminWhatsAppAlert, formatOrderWhatsAppMessage, formatRestaurantKOTMessage, sendSubstitutionWhatsApp (+46 more)
...
### Community 295 - "edit_restaurant_product_modal.dart"
Cohesion: 0.08
...
Cohesion: 0.03
Nodes (69): donut_capacity_painter.dart, AdminOrdersEmptyView, build, isLive, onRefresh, primaryRed, CartCelebrationModal, show (+61 more)
...
### Community 300 - "ConsumerState"
Cohesion: 0.05
Nodes (67): CategoriesScreen, ConsumerState, ConsumerStatefulWidget, ../../core/widgets/loading_widgets.dart, DeliveryLoginScreen, AdminProductsScreen, _AdminProductsScreenState, build (+59 more)
...
### Community 310 - "profile_menu_item.dart"
Cohesion: 0.09
Nodes (20): AdminStatCard, bgColor, borderColor, build, icon, iconColor, subtitle, title (+12 more)
...
### Community 313 - "store_hub_provider.dart"
Cohesion: 0.11
...
### Community 315 - "phone.ts"
Cohesion: 0.08
Nodes (30): POST(), POST(), POST(), POST(), POST(), POST(), GET(), POST() (+22 more)
...
### Community 317 - "restaurant_repository.dart"
Cohesion: 0.11
...
### Community 319 - "cart_bill_summary_card.dart"
Cohesion: 0.18
...
### Community 323 - "admin_order_card.dart"
Cohesion: 0.11
...
### Community 329 - "admin_stats_grid.dart"
Cohesion: 0.20
...
### Community 330 - "live_clock_badge.dart"
Cohesion: 0.13
...
Cohesion: 0.03
Nodes (83): CheckoutCouponInput(), CouponInputProps, CheckoutOrderSummary(), OrderSummaryProps, ActiveDeliveryCard(), ActiveDeliveryCardProps, itemVariants, DeliveryHistoryView() (+75 more)
...
### Community 341 - "restaurant_sales_report_tab.dart"
Cohesion: 0.11
...
### Community 348 - "address_repository.dart"
Cohesion: 0.13
...
### Community 351 - "app_confirmation_dialog.dart"
Cohesion: 0.11
...
### Community 352 - "middleware/auth.py"
Cohesion: 0.16
...
Cohesion: 0.06
Nodes (44): AddressCreate, Settings, get_db(), CurrentUser, get_current_user(), get, root(), Address (+36 more)

### Community 354 - "notifications_screen.dart"
Cohesion: 0.12
...
Cohesion: 0.05
Nodes (45): CartRepository, main, main, main, main, main, main, main (+37 more)
...
Cohesion: 0.07
Nodes (31): Completer, ../data/repositories/wishlist_repository.dart, Dio, ApiException, dio, _isRefreshingToken, kNetworkRetryDelays, message (+23 more)

### Community 360 - "edit_order"
Cohesion: 0.20
Nodes (12): edit_order(), get_order_items(), get_order_live_status(), get_recent_orders(), Any, AsyncSession, get, patch (+4 more)

### Community 362 - "run_payment_recovery_cron"
Cohesion: 0.17
Nodes (16): cleanup_abandoned_carts(), inventory_sync_audit(), keep_alive_cron(), Any, AsyncSession, get, post, Request (+8 more)

### Community 363 - "tracking_widgets_test.dart"
Cohesion: 0.18
...
### Community 365 - "../../core/services/logger_service.dart"
Cohesion: 0.07
...
### Community 366 - "formatDate"
Cohesion: 0.06
Nodes (39): DeliveryHeader(), DeliveryHeaderProps, LiveClock(), ProductPage(), AdminAlerts(), AdminAlertsProps, AlertItem, Counts (+31 more)

### Community 367 - "constants.ts"
Cohesion: 0.04
Nodes (59): AdminBulkUpdate(), AdminBulkUpdateProps, BatchHistory, Category, ChangePreview, Product, AdminRestaurantConsole(), AdminRestaurantConsoleProps (+51 more)

### Community 368 - "brand_button.dart"
Cohesion: 0.12
Nodes (16): BorderRadius?, backgroundColor, borderRadius, BrandButton, build, fontSize, fullWidth, gradientEnd (+8 more)

### Community 369 - "lib/widgets/empty_state.dart"
Cohesion: 0.09
...
### Community 373 - "order_repository.dart"
Cohesion: 0.12
...
### Community 374 - "logger_service.dart"
Cohesion: 0.22
...
### Community 377 - "restaurant_card.dart"
Cohesion: 0.12
...
### Community 381 - "delivery-routing.ts"
Cohesion: 0.43
...
### Community 390 - "app/error.tsx"
Cohesion: 0.48
Nodes (4): Error(), GlobalError(), reportClientError(), TelemetryContext

### Community 391 - "picker_scan_screen.dart"
Cohesion: 0.14
...
### Community 398 - "admin_authorization.dart"
Cohesion: 0.17
...
### Community 400 - "register_fcm_token"
Cohesion: 0.27
...
### Community 406 - "auth"
Cohesion: 0.04
Nodes (66): AccountPage(), dynamic, revalidate, WishlistPage(), EditRestaurantPage(), NewRestaurantPage(), AdminRestaurantsPage(), revalidate (+58 more)
...
### Community 421 - "get_ai_demand_forecast"
Cohesion: 0.40
...
### Community 430 - "1. THE THREE DIALS (Core Configuration)"
Cohesion: 0.50
...
### Community 433 - "check-store/route.ts"
Cohesion: 0.83
Nodes (3): calculateDistanceKm(), GET(), isPointInPolygon()

### Community 434 - "State"
Cohesion: 0.10
Nodes (30): AdminCouponsDetailScreen, _AdminCouponsDetailScreenState, SplashScreen, _SplashScreenState, RestaurantMenuCatalogTab, _RestaurantMenuCatalogTabState, CartCouponCard, _CartCouponCardState (+22 more)
...
### Community 441 - "admin_filter_header.dart"
Cohesion: 0.08
...
- **Why does `delete` connect `User` to `core/database.py`, `create_order`, `Order`, `Product`, `push_notify_bridge`, `models.py`, `send_otp`, `Category`, `fastapi-backend/routers/addresses.py`, `Restaurant`, `fastapi-backend/routers/cart.py`, `secure_storage_service.dart`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `Product` connect `Product` to `User`, `create_order`, `Order`, `get_ai_demand_forecast`, `models.py`, `run_payment_recovery_cron`, `get_picker_orders`, `Category`, `Restaurant`, `fastapi-backend/routers/cart.py`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `dependencies` connect `dependencies` to `package.json`, `@google/genai`, `framer-motion`, `@types/node`, `react-dom`, `dotenv`, `firebase-admin`, `@auth/prisma-adapter`, `next`, `nodemailer`, `pg`, `shadcn`, `sharp`, `libphonenumber-js`, `@prisma/adapter-pg`, `lucide-react`, `tailwindcss`, `react`, `@supabase/supabase-js`, `@types/web-push`, `@types/bcryptjs`, `@types/react-dom`, `web-push`, `@types/nodemailer`, `zod`, `@upstash/redis`, `next-auth`, `sonner`, `@tailwindcss/postcss`, `zustand`?**
...
- **Should `User` be split into smaller, more focused modules?**
  _Cohesion score 0.038261691072272085 - nodes in this community are weakly interconnected._
- **Should `cart_repository.dart` be split into smaller, more focused modules?**
