...
## Corpus Check
- 1061 files · ~3,505,020 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 10279 nodes · 18491 edges · 471 communities (387 shown, 84 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 635 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `642a7025`
...
## Communities (471 total, 84 thin omitted)

### Community 0 - "package:flutter/material.dart"
Cohesion: 0.02
Nodes (126): admin_stat_card.dart, ../../cafe/restaurant_dashboard.dart, ../../core/services/admin_authorization.dart, ../../../core/services/battery_optimization_service.dart, ../core/theme/design_system.dart, ../../../core/utils/order_item_helper.dart, AboutScreen, build (+118 more)

### Community 1 - "admin_extended.py"
Cohesion: 0.03
Nodes (161): Banner, Coupon, PromoBanner, RestaurantPayout, Review, StoreSetting, User, admin_batch_patch_products() (+153 more)

### Community 2 - "delivery_location_screen.dart"
Cohesion: 0.02
Nodes (94): Address?, ../core/services/location_service.dart, ../data/models/address.dart, DeliveryTierInfo, LocationDetails, _Address, build, CartFreeDeliveryBar (+86 more)

### Community 3 - "checkout.ts"
Cohesion: 0.05
Nodes (63): GET(), DeliverySelectorProps, Address, CreateOrderModal(), CreateOrderModalProps, CustomerUser, Product, SelectedItem (+55 more)
...
Cohesion: 0.02
Nodes (96): address_book_screen.dart, ../../auth/login_screen.dart, FadeSlideRoute, _loadSettings, build, _handleContinue, _buildMenuTab, build (+88 more)

### Community 8 - "vendor_login.dart"
Cohesion: 0.08
Nodes (25): ../../admin/vendor_console_screen.dart, core/routes/app_router.dart, core/services/deep_link_service.dart, ../core/services/notification_service.dart, core/theme/app_theme.dart, build, createState, dispose (+17 more)
...
### Community 12 - "cn"
Cohesion: 0.05
Nodes (54): AccountDashboardProps, WishlistClient(), WishlistItem, RestaurantManager(), RestaurantManagerProps, OrderForSomeoneCard(), OrderForSomeoneCardProps, SlideToOrder() (+46 more)
...
### Community 14 - "../core/routes/page_transitions.dart"
Cohesion: 0.05
Nodes (39): category_products_screen.dart, ../core/routes/page_transitions.dart, ../coupons_screen.dart, ../data/models/store_hub.dart, appliedCoupon, bogoBadgeText, build, controller (+31 more)

### Community 15 - "delivery/page.tsx"
Cohesion: 0.09
Nodes (27): CheckoutDeliverySelector(), ActiveDeliveryCard(), ActiveDeliveryCardProps, itemVariants, CodPaymentModal(), CodPaymentModalProps, ModalStep, DeliveryHistoryView() (+19 more)
...
Cohesion: 0.01
Nodes (164): ../core/config/app_config.dart, ../core/theme/responsive.dart, dart:math, EdgeInsets, bestTokenFuzzyDistance, damerauLevenshtein, FuzzyMatcher, isFuzzyMatch (+156 more)
...
Cohesion: 0.05
Nodes (54): UpiQrModal(), loadQrData(), UpiQrModalProps, Error(), GlobalError(), OrderConfirmPage(), OrderConfirmPageProps, AdminForecast() (+46 more)
...
Cohesion: 0.05
Nodes (52): CheckoutPage(), CheckoutVerifyContent(), jakarta, metadata, RootLayout(), viewport, EmptyCartScreen(), InventoryIssueScreen() (+44 more)
...
Cohesion: 0.04
Nodes (79): ../../categories/category_products_screen.dart, CategoriesScreen, ConsumerState, ConsumerStatefulWidget, ../../core/widgets/loading_widgets.dart, ../data/models/category.dart, build, _OperationsBottomSheet (+71 more)

### Community 32 - "validation.ts"
Cohesion: 0.09
Nodes (28): POST(), POST(), DELETE(), GET(), getOrCreateCart(), getOrCreateGuestUser(), POST(), POST() (+20 more)
...
### Community 35 - "admin.py"
Cohesion: 0.11
Nodes (44): CashDepositTransaction, DarkStore, Role, admin_set_user_password(), admin_sync_razorpay_order(), admin_update_user(), block_user_alias(), delete_rider_cash_log() (+36 more)

### Community 36 - "utils.ts"
Cohesion: 0.05
Nodes (48): CategoryPage(), CategoryPageProps, revalidate, CheckoutOrderSummary(), OrderSummaryProps, iconMap, ProductPageProps, revalidate (+40 more)
...
### Community 41 - "hub_waitlist_sheet.dart"
Cohesion: 0.12
...
Cohesion: 0.03
Nodes (57): bool?, ../../core/services/admin_notification_service.dart, ../data/models/order.dart, AdminNotificationService, fireAdminWhatsAppAlert, formatOrderWhatsAppMessage, formatRestaurantKOTMessage, sendSubstitutionWhatsApp (+49 more)
...
Cohesion: 0.07
Nodes (67): CartPage(), dynamic, findRestaurantBySlug(), FoodRestaurantPage(), generateMetadata(), BogoCartGiftCard(), BogoCartGiftCardProps, CartConflictDialog() (+59 more)
...
### Community 54 - "cafe-section.tsx"
Cohesion: 0.06
Nodes (32): AdminRestaurantConsole(), AdminRestaurantConsoleProps, Product, Category, Product, RestaurantCatalogManager(), RestaurantCatalogManagerProps, RestaurantConsoleTab() (+24 more)
...
### Community 56 - "prisma"
Cohesion: 0.05
Nodes (31): GET(), GET(), dynamic, calculateDistanceKm(), GET(), isPointInPolygon(), memoryStockCache, GET() (+23 more)
...
### Community 61 - "home_screen.dart"
Cohesion: 0.06
Nodes (31): build, createState, didChangeAppLifecycleState, dispose, _homeScrollController, _isGrocerySelected, _isLoadingMoreGrid, _onHomeScroll (+23 more)
...
Cohesion: 0.07
Nodes (33): GET(), POST(), dynamic, GET(), POST(), dynamic, GET(), dynamic (+25 more)
...
### Community 87 - "api/orders/route.ts"
Cohesion: 0.07
Nodes (49): AdminPage(), revalidate, GET(), GET(), POST(), GET(), POST(), buildSettingsMap() (+41 more)
...
Cohesion: 0.07
Nodes (27): badgePink, brandRed, brandRedEnd, build, _buildFeatureBadge, _buildTncSection, createState, dispose (+19 more)

### Community 90 - "formatPrice"
Cohesion: 0.03
Nodes (95): CheckoutCouponInput(), CouponInputProps, DeliveryHeader(), DeliveryHeaderProps, LiveClock(), DeliveryWalletCard(), DeliveryWalletCardProps, ProductPage() (+87 more)
...
Cohesion: 0.04
Nodes (43): AdminDashboard(), AdminDashboardProps, BlockCustomerModal, CategoryEditModal, CreateOrderModal, MediaLibraryModal, OrderTrackingModal, ReviewEditModal (+35 more)

### Community 101 - "High-Agency Frontend Skill"
Cohesion: 0.06
Nodes (30): 10. FINAL PRE-FLIGHT CHECK, 1. ACTIVE BASELINE CONFIGURATION, 2. DEFAULT ARCHITECTURE & CONVENTIONS, 3. DESIGN ENGINEERING DIRECTIVES (Bias Correction), 4. CREATIVE PROACTIVITY (Anti-Slop Implementation), 5. PERFORMANCE GUARDRAILS, 6. TECHNICAL REFERENCE (Dial Definitions), 7. AI TELLS (Forbidden Patterns) (+22 more)

### Community 102 - "revalidateStorefront"
Cohesion: 0.09
Nodes (27): computeNewValue(), DELETE(), generateBatchId(), GET(), POST(), POST(), ServiceabilityAction, ServiceabilityTarget (+19 more)

### Community 103 - "package:flutter_riverpod/flutter_riverpod.dart"
Cohesion: 0.02
Nodes (124): ../cart/cart_screen.dart, cart_conflict_dialog.dart, ../../checkout/checkout_screen.dart, ConsumerWidget, ../core/utils/dish_timing.dart, ../core/utils/restaurant_utils.dart, AdminOrderCard, appliedCoupon (+116 more)

### Community 104 - "../core/network/api_client.dart"
Cohesion: 0.04
Nodes (51): address_provider.dart, cart_provider.dart, ../core/network/api_client.dart, ../../core/services/logger_service.dart, ../core/services/supabase_service.dart, ../data/repositories/coupon_repository.dart, build, completed (+43 more)

### Community 105 - "models.py"
Cohesion: 0.04
Nodes (91): Address, Cart, DishVariant, FoodDish, InventoryLog, PayoutRequest, PriceHistory, ProductBatch (+83 more)
...
Cohesion: 0.15
Nodes (24): Category, clear_categories_cache(), create_category(), delete_category(), generate_id(), get_categories(), get_categories_catalog(), get_category_products() (+16 more)
...
### Community 121 - "cart_repository.dart"
Cohesion: 0.13
...
### Community 133 - "tracking_status_stepper.dart"
Cohesion: 0.10
...
### Community 141 - "main_shell.dart"
Cohesion: 0.15
Nodes (16): ../categories/categories_screen.dart, build, _buildLiquidBottomNav, createState, didChangeAppLifecycleState, dispose, initState, _lastBackPressTime (+8 more)
...
Cohesion: 0.02
Nodes (97): ../data/models/product.dart, ../data/repositories/product_repository.dart, ProductRepository, _buildFilterPill, category, createState, dispose, emoji (+89 more)
...
### Community 154 - "List"
Cohesion: 0.03
Nodes (75): CartItem, ../../../core/widgets/app_cached_image.dart, ../data/models/cart.dart, CachedMapTileProvider, customHeaders, getImage, bgMain, brandGreen (+67 more)
...
### Community 196 - "package:fastkirana_flutter/core/services/logger_service.dart"
Cohesion: 0.07
...
### Community 228 - "sync_razorpay_order_in_payments"
Cohesion: 0.22
...
### Community 244 - "Order"
Cohesion: 0.14
Nodes (27): Order, accept_batch_orders(), confirm_doorstep_qr_payment(), get_delivery_orders(), get_doorstep_qr(), get_rider_delivery_location(), get_rider_wallet(), haversine_km() (+19 more)
...
### Community 262 - "models/__init__.py"
Cohesion: 0.09
Nodes (18): FastAPI, Database initialization script. Run with: python init_db.py, get_banners(), AsyncSession, get, Response, Get active promotional banners with ultra-fast in-memory caching., broadcast_kot() (+10 more)
...
### Community 295 - "checkout_screen.dart"
Cohesion: 0.09
...
Cohesion: 0.02
Nodes (115): Color, actionLabel, build, EmptyState, icon, onAction, subtitle, title (+107 more)

### Community 298 - "cron.py"
Cohesion: 0.19
...
Cohesion: 0.06
Nodes (63): Restaurant, create_restaurant(), create_restaurant_section(), delete_restaurant(), generate_restaurant_slug(), get_restaurant_details(), get_restaurant_menu(), get_restaurant_sections() (+55 more)
...
### Community 319 - "picker_scan_screen.dart"
Cohesion: 0.14
...
### Community 320 - "State"
Cohesion: 0.08
Nodes (34): AdminCouponsDetailScreen, _AdminCouponsDetailScreenState, build, couponId, createState, _infoRow, _isActive, SplashScreen (+26 more)
...
### Community 336 - "Product"
Cohesion: 0.05
Nodes (73): OrderStatus, OrderType, PaymentMethod, PaymentStatus, Product, str, Any, Enterprise Quick-Commerce Payment Recovery & Order Lifecycle Engine. Follows… (+65 more)

### Community 337 - "search_screen.dart"
Cohesion: 0.03
Nodes (79): app_cached_image.dart, ../../cafe/cafe_menu_screen.dart, ../../core/utils/fuzzy_matcher.dart, curated_brand_offer_card.dart, ../data/models/banner.dart, ../data/models/brand_offer_card_data.dart, ../data/models/restaurant.dart, ../data/repositories/banner_repository.dart (+71 more)

### Community 338 - "selectedAddressProvider"
Cohesion: 0.08
Nodes (34): bootstrapUserLocation, checkLocationDriftAndPrompt, deliveryTierProvider, LocationService, _buildCartScreenContent, CheckoutController, CheckoutState, _checkAndRevalidateCatalog (+26 more)
...
### Community 345 - "doorstep_details_screen.dart"
Cohesion: 0.08
...
### Community 351 - "core/database.py"
Cohesion: 0.09
Nodes (23): get_db(), PromoBanner, Base, Category, Base, Product, Base, Base (+15 more)
...
### Community 363 - "dart:async"
Cohesion: 0.14
Nodes (12): AudioPlayer, dart:async, NetworkRetryHelper, CustomerSoundService, dispose, _initPlayer, instance, _isInitialized (+4 more)
...
### Community 365 - "_RestaurantsListScreenState"
Cohesion: 0.43
...
### Community 366 - "formatters.ts"
Cohesion: 0.12
Nodes (19): HandoverConfirmModal(), HandoverConfirmModalProps, CheckoutBillSummary(), CheckoutBillSummaryProps, CheckoutCartReview(), CheckoutMobileBar(), DATE_RANGE_LABELS, DateRangePreset (+11 more)
...
Cohesion: 0.10
Nodes (27): GET(), GET(), PATCH(), POST(), DELETE(), PATCH(), POST(), GET() (+19 more)
...
### Community 373 - "restaurant-report.service.ts"
Cohesion: 0.22
...
### Community 381 - "core_components_widget_test.dart"
Cohesion: 0.10
...
### Community 388 - "store_settings_provider.dart"
Cohesion: 0.33
...
### Community 391 - "order_item_helper.dart"
Cohesion: 0.29
...
### Community 398 - "brand_button.dart"
Cohesion: 0.12
...
### Community 400 - "middleware/auth.py"
Cohesion: 0.16
...
### Community 406 - "auth"
Cohesion: 0.04
Nodes (68): WishlistPage(), EditRestaurantPage(), NewRestaurantPage(), AdminRestaurantsPage(), revalidate, AdminVendorsPage(), revalidate, DELETE() (+60 more)
...
### Community 436 - "AdminRidersFleetTab.tsx"
Cohesion: 0.40
...
### Community 438 - "cashfree_router.py"
Cohesion: 0.22
...
### Community 439 - "1. THE THREE DIALS (Core Configuration)"
Cohesion: 0.50
...
### Community 460 - "package:flutter/services.dart"
Cohesion: 0.03
Nodes (70): donut_capacity_painter.dart, AdminOrdersEmptyView, build, isLive, onRefresh, primaryRed, CartCelebrationModal, show (+62 more)
...
### Community 464 - "curated_brand_offer_card_test.dart"
Cohesion: 0.29
...
- **Why does `delete` connect `admin_extended.py` to `create_order`, `admin.py`, `add_to_wishlist`, `models.py`, `profile.py`, `Restaurant`, `Product`, `Category`, `routers/push.py`, `app/routers/orders.py`, `fastapi-backend/routers/cart.py`, `secure_storage_service.dart`, `fastapi-backend/routers/addresses.py`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `Product` connect `Product` to `admin_extended.py`, `create_order`, `admin.py`, `add_to_wishlist`, `models.py`, `cron.py`, `picker.py`, `Restaurant`, `Category`, `validate_coupon`, `fastapi-backend/routers/cart.py`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `dependencies` connect `dependencies` to `package.json`, `@google/genai`, `clsx`, `framer-motion`, `date-fns`, `@types/node`, `lru-cache`, `react-dom`, `dotenv`, `prisma`, `@types/papaparse`, `@types/pg`, `xlsx`, `@auth/prisma-adapter`, `create_order`, `lucide-react`, `next-auth`, `@prisma/adapter-pg`, `next`, `@types/web-push`, `papaparse`, `@prisma/client`, `resend`, `shadcn`, `zod`, `tailwindcss`, `@types/react-dom`, `web-push`, `sonner`, `@tailwindcss/postcss`, `zustand`?**
...
- **Should `package:flutter/material.dart` be split into smaller, more focused modules?**
  _Cohesion score 0.017638412542871143 - nodes in this community are weakly interconnected._
- **Should `admin_extended.py` be split into smaller, more focused modules?**
  _Cohesion score 0.03325001893509051 - nodes in this community are weakly interconnected._
- **Should `delivery_location_screen.dart` be split into smaller, more focused modules?**
  _Cohesion score 0.02352501867064974 - nodes in this community are weakly interconnected._