...
## Corpus Check
- 1007 files · ~3,406,220 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 9415 nodes · 16512 edges · 459 communities (375 shown, 84 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 351 edges (avg confidence: 0.52)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `995f2aa4`
...
5. `formatPrice()` - 93 edges
6. `dioProvider` - 91 edges
7. `triggerHaptic()` - 78 edges
8. `getLast10Digits()` - 59 edges
9. `useUIStore` - 56 edges
10. `revalidateStorefront()` - 53 edges
...
## Communities (459 total, 84 thin omitted)

### Community 0 - "package:flutter/material.dart"
Cohesion: 0.02
Nodes (91): ../cafe/restaurant_dashboard.dart, ../core/theme/design_system.dart, AboutScreen, build, _divider, _linkItem, _statBox, AdminBannersScreen (+83 more)

### Community 1 - "admin_extended.py"
Cohesion: 0.05
Nodes (95): Coupon, Product, admin_block_user(), admin_bulk_import_products(), admin_bulk_sort_products(), admin_bulk_update(), admin_create_banner(), admin_create_category() (+87 more)

### Community 2 - "prisma.ts"
Cohesion: 0.03
Nodes (81): AdminPage(), revalidate, GET(), PATCH(), POST(), PUT(), dynamic, POST() (+73 more)

### Community 3 - "main_shell.dart"
Cohesion: 0.13
Nodes (18): ../categories/categories_screen.dart, ../delivery/picker_dashboard.dart, build, _buildLiquidBottomNav, createState, didChangeAppLifecycleState, dispose, initState (+10 more)
...
### Community 5 - "cn"
Cohesion: 0.05
Nodes (57): RootLayout(), iconMap, ProductPageProps, revalidate, AccountDashboardProps, WishlistClient(), WishlistItem, RestaurantManagerProps (+49 more)
...
### Community 7 - "variant_selector_sheet.dart"
Cohesion: 0.03
Nodes (56): cart_conflict_dialog.dart, CachedMapTileProvider, customHeaders, getImage, build, CartBillDetailsCard, CartBillRow, couponDiscount (+48 more)

### Community 8 - "category_products_screen.dart"
Cohesion: 0.06
Nodes (31): category_products_screen.dart, build, _buildReferenceCategoryCard, CategoriesScreen, createState, dispose, _searchController, _searchQuery (+23 more)

### Community 9 - "picker/page.tsx"
Cohesion: 0.09
Nodes (32): BinPlacementAlert(), BinPlacementAlertProps, CameraScannerOverlay(), CameraScannerOverlayProps, MultiOrderConsole(), MultiOrderConsoleProps, PickerQueueList(), PickerQueueListProps (+24 more)

### Community 10 - "ConsumerState"
Cohesion: 0.06
Nodes (55): CategoriesScreen, ConsumerState, ConsumerStatefulWidget, DeliveryLoginScreen, AdminProductsScreen, _AdminProductsScreenState, build, _DeliveryLoginScreenState (+47 more)
...
Cohesion: 0.12
Nodes (26): check_live_stock(), create_product(), delete_product(), generate_slug(), get_fuzzy_score(), get_levenshtein_distance(), get_product_details(), get_product_limit() (+18 more)
...
### Community 20 - "home_category_toggle.dart"
Cohesion: 0.11
...
### Community 30 - "../core/services/location_service.dart"
Cohesion: 0.09
Nodes (21): Address?, ../core/services/location_service.dart, ../data/models/address.dart, DeliveryTierInfo, LocationDetails, _Address, build, CartFreeDeliveryBar (+13 more)
...
### Community 32 - "auth"
Cohesion: 0.05
Nodes (56): WishlistPage(), EditRestaurantPage(), NewRestaurantPage(), DELETE(), GET(), PATCH(), POST(), PUT() (+48 more)
...
Cohesion: 0.06
Nodes (66): Address, Banner, Cart, CashDepositTransaction, DarkStore, FcmToken, InventoryLog, OtpToken (+58 more)

### Community 35 - "index.ts"
Cohesion: 0.04
Nodes (74): dynamic, revalidate, CategoryPage(), CategoryPageProps, revalidate, CheckoutOrderSummary(), OrderSummaryProps, getCachedAllGroceryProducts (+66 more)
...
Cohesion: 0.05
Nodes (33): ../../../core/services/battery_optimization_service.dart, build, isUpdating, onAcceptAndCook, onEditOrder, onMarkReady, onPrintKot, onReject (+25 more)
...
Cohesion: 0.03
Nodes (65): ../../cafe/cafe_menu_screen.dart, ../../core/utils/fuzzy_matcher.dart, curated_brand_offer_card.dart, ../data/models/banner.dart, ../data/models/brand_offer_card_data.dart, ../data/models/restaurant.dart, ../data/repositories/banner_repository.dart, empty_state.dart (+57 more)
...
Cohesion: 0.05
Nodes (90): POST(), CartPage(), jakarta, metadata, viewport, CartConflictDialog(), CartDrawer(), CartStickyBar() (+82 more)
...
Cohesion: 0.04
Nodes (49): design_system.dart, AppTheme, _pageTransitionsTheme, defaultBanners, defaultFoodBanners, defaultGroceryBanners, dio, _diskBannersPrefix (+41 more)
...
Cohesion: 0.06
Nodes (29): bool get, Connectivity, _checkConnection, _connectivity, dispose, _init, _isOnline, observer (+21 more)
...
### Community 72 - "Order"
Cohesion: 0.08
Nodes (53): Order, OrderItem, OrderStatus, OrderType, PaymentMethod, PaymentStatus, str, get_admin_rider_cash_summary() (+45 more)
...
### Community 79 - "cart_coupon_card.dart"
Cohesion: 0.07
Nodes (28): ../coupons_screen.dart, appliedCoupon, bogoBadgeText, build, CartCouponCard, _CartCouponCardState, controller, couponDiscount (+20 more)
...
Cohesion: 0.08
Nodes (35): PATCH(), POST(), DELETE(), GET(), PATCH(), POST(), buildSettingsMap(), checkIsStoreOpen() (+27 more)
...
Cohesion: 0.07
Nodes (28): BoxFit, borderRadius, build, _buildFallbackVisual, _buildPosterLayer, CardMediaWidget, _CardMediaWidgetState, createState (+20 more)

### Community 100 - "admin-dashboard.tsx"
Cohesion: 0.06
Nodes (34): AdminDashboard(), AdminDashboardProps, BlockCustomerModal, CreateOrderModal, MediaLibraryModal, TabType, BlockCustomerModal(), BlockCustomerModalProps (+26 more)
...
Cohesion: 0.12
Nodes (18): ../core/utils/app_connectivity.dart, connectivityProvider, build, createState, dispose, OfflineBanner, _OfflineBannerState, offlineText (+10 more)

### Community 103 - "login_screen.dart"
Cohesion: 0.03
Nodes (60): Color, build, _buildTncSection, createState, dispose, _errorMessage, _focusNode, _handleSkipGuest (+52 more)
...
### Community 106 - "splash/splash_screen.dart"
Cohesion: 0.05
Nodes (37): ../../categories/category_products_screen.dart, ../data/models/category.dart, ../data/models/store_hub.dart, category, createState, _selectedSubIdx, SubcategoryScreen, buildAvatarImage (+29 more)
...
### Community 111 - "List"
Cohesion: 0.03
Nodes (74): ../auth/login_screen.dart, ../cart/cart_screen.dart, CartItem, ../../checkout/checkout_screen.dart, ../core/routes/page_transitions.dart, ../core/utils/dish_timing.dart, ../core/utils/restaurant_utils.dart, ../data/models/cart.dart (+66 more)

### Community 112 - "seed.ts"
Cohesion: 0.33
Nodes (4): adapter, pool, prisma, NOTE: We do NOT delete any products, categories, or orders.

### Community 113 - "orders_screen.dart"
Cohesion: 0.04
Nodes (49): ../data/models/product.dart, badgeText, build, FlashDealsCarousel, onSeeAll, products, subtitle, title (+41 more)

### Community 114 - "app_router.dart"
Cohesion: 0.10
Nodes (20): AppRouter, generateRoute, navigatorKey, ../../features/auth/admin_login.dart, ../../features/auth/delivery_login.dart, ../../features/auth/login_screen.dart, ../../features/auth/otp_screen.dart, ../../features/cafe/restaurant_dashboard.dart (+12 more)
...
Cohesion: 0.06
Nodes (67): POST(), POST(), POST(), GET(), POST(), POST(), POST(), GET() (+59 more)
...
Cohesion: 0.06
Nodes (35): ConfettiController, _animController, _buildDetailRow, _buildProgressLine, _buildProgressStep, _buttonsFadeAnim, _buttonsSlideAnim, _checkScaleAnim (+27 more)
...
### Community 132 - "revalidateStorefront"
Cohesion: 0.06
Nodes (42): DELETE(), GET(), POST(), PUT(), computeNewValue(), DELETE(), generateBatchId(), GET() (+34 more)
...
### Community 150 - "category-edit-modal.tsx"
Cohesion: 0.40
...
### Community 153 - "selectedAddressProvider"
Cohesion: 0.13
Nodes (24): bootstrapUserLocation, checkLocationDriftAndPrompt, LocationService, CheckoutController, CheckoutState, initState, build, build (+16 more)
...
Cohesion: 0.03
Nodes (85): BorderRadius?, BoxShape, double?, EdgeInsets, AppShimmer, build, child, count (+77 more)
...
Cohesion: 0.07
Nodes (29): class, _barcodeController, brandGreen, brandOrange, build, _commonUnits, createState, _descriptionController (+21 more)

### Community 173 - "restaurant-orders-console.tsx"
Cohesion: 0.07
Nodes (42): RestaurantKitchenPage(), OrdersTab(), CompanionOrder, containerVariants, foodEmojis, formatElapsed(), getItemEmoji(), getOrderCardSlaBorder() (+34 more)
...
Cohesion: 0.05
Nodes (40): apiBaseUrl, AppConfig, appIconAsset, appName, appVersion, buildFlavor, buildNumber, cashfreeAppId (+32 more)
...
Cohesion: 0.04
Nodes (46): @immutable, ../../core/constants/api_endpoints.dart, backgroundColorHex, brandLogos, BrandOfferCardData, cardType, cashbackSubtitle, cashbackTitle (+38 more)
...
Cohesion: 0.09
Nodes (20): address_book_screen.dart, ../../data/repositories/auth_repository.dart, _buildMenuItem, _buildOperationBentoTile, _buildSectionHeader, _buildShortcutCard, _buildUserHeader, primaryRed (+12 more)
...
Cohesion: 0.06
Nodes (36): ../common/order_edit_modal.dart, _autoRefreshTimer, bgMain, brandGreen, brandOrange, build, _buildEmptyState, _buildMetricStrip (+28 more)
...
Cohesion: 0.06
Nodes (33): ../../../../core/services/kot_print_service.dart, ../../core/services/logger_service.dart, ../core/services/supabase_service.dart, ../../../core/utils/app_toast.dart, dart:async, ../data/repositories/order_repository.dart, NetworkRetryHelper, formatKitchenWhatsAppMessage (+25 more)
...
Cohesion: 0.11
Nodes (15): POST(), dynamic, GET(), POST(), dynamic, GET(), dynamic, GET() (+7 more)
...
### Community 299 - "home_screen.dart"
Cohesion: 0.09
...
Cohesion: 0.05
Nodes (40): ../admin/admin_dashboard.dart, ../data/models/user.dart, AdminLoginScreen, _AdminLoginScreenState, build, createState, dispose, _emailController (+32 more)
...
### Community 310 - "storefront-client.tsx"
Cohesion: 0.04
Nodes (54): CUISINES, FoodMarketplace(), FoodMarketplaceProps, SortOption, OfferItem, RestaurantOffersCarousel(), RestaurantOffersCarouselProps, CategoryTabItem() (+46 more)

### Community 311 - "delivery_payment_sheet.dart"
Cohesion: 0.05
Nodes (42): build, createState, _currentPage, dispose, _navigateToLogin, OnboardingScreen, _OnboardingScreenState, _pageController (+34 more)
...
### Community 314 - "product_card.dart"
Cohesion: 0.03
Nodes (60): DishTimingStatus, _addButton, bestseller, bogo, bogoBadgeText, child, createState, discount (+52 more)

### Community 315 - "getLast10Digits"
Cohesion: 0.06
Nodes (43): AccountPage(), dynamic, revalidate, POST(), POST(), POST(), POST(), POST() (+35 more)
...
Cohesion: 0.04
Nodes (51): build, isBusyMode, isStoreOpen, onToggleBusyMode, onToggleStoreOpen, RestaurantSettingsTab, CartCelebrationModal, show (+43 more)
...
### Community 329 - "State"
Cohesion: 0.11
Nodes (18): _SplashScreenState, backgroundColor, borderColor, build, createState, dispose, fontSize, _formatTime (+10 more)
...
### Community 333 - "food/[slug]/page.tsx"
Cohesion: 0.21
Nodes (8): POST(), dynamic, findRestaurantBySlug(), FoodRestaurantPage(), generateMetadata(), OUTLET_AS_RESTAURANT_ID, OUTLET_PARI_MILK_ID, OUTLET_WEDSON_ID
...
### Community 335 - "cartProvider"
Cohesion: 0.05
Nodes (62): ConsumerWidget, ../data/models/store_settings.dart, FadeSlideRoute, deliveryTierProvider, _loadSettings, AdminOrderCard, build, _handleContinue (+54 more)
...
### Community 341 - "extractCityFromStoreName"
Cohesion: 0.12
Nodes (21): AdminRestaurantsPage(), revalidate, GET(), checkAdmin(), GET(), PATCH(), POST(), GET() (+13 more)
...
### Community 345 - "home_top_header.dart"
Cohesion: 0.18
Nodes (11): createState, dispose, _dynamicPlaceholders, HomeTopHeader, _HomeTopHeaderState, initState, _searchPlaceholderIndex, _searchTimer (+3 more)

### Community 347 - "package:flutter_riverpod/flutter_riverpod.dart"
Cohesion: 0.05
Nodes (42): ../core/network/api_client.dart, ../../core/widgets/loading_widgets.dart, ../data/repositories/product_repository.dart, ../data/repositories/wishlist_repository.dart, ProductRepository, WishlistRepository, AdminRefundSheet, show (+34 more)
...
### Community 349 - "store_hub_provider.dart"
Cohesion: 0.05
Nodes (36): city, defaultAkbarpur, defaultGhatampur, defaultHubs, deliveryRadiusKm, fromJson, groceryOpen, id (+28 more)

### Community 351 - "track/page.tsx"
Cohesion: 0.20
Nodes (8): dynamic, getOrderDetails(), OrderTrackingPage(), OrderTrackingPageProps, SupabaseAuthBridge(), TrackingPageClient(), TrackingPageClientProps, supabase
...
Cohesion: 0.12
Nodes (17): AsyncValue, ../data/repositories/address_repository.dart, addAddress, addressesAsync, AddressesNotifier, clear, deleteAddress, loadAddresses (+9 more)

### Community 354 - "checkout_bill_breakdown.dart"
Cohesion: 0.18
...
Cohesion: 0.04
Nodes (52): checkDishTimeAvailability, DishTimingStatus, formattedTimeSlot, formatTime12h, isAvailableNow, nextAvailableTimeStr, AdminStatCard, bgColor (+44 more)

### Community 367 - "restaurant_card.dart"
Cohesion: 0.08
Nodes (22): _buildFallbackOfferTicket, _buildOfferTicketCard, currentRestaurant, restaurantId, build, _buildDefaultFallback, _buildImagePlaceholder, _buildLocalOrFallbackImage (+14 more)

### Community 368 - "AnimationController"
Cohesion: 0.20
...
Cohesion: 0.07
Nodes (32): ../data/models/coupon.dart, ../data/repositories/coupon_repository.dart, CouponRepository, AdminCouponsScreen, build, build, CafeOffersStrip, _applyCode (+24 more)
...
### Community 381 - "admin_authorization.dart"
Cohesion: 0.17
...
### Community 390 - "CategoryOfferCard"
Cohesion: 0.67
Nodes (3): CategoryOfferCard, _CategoryOfferCardState, CuratedBrandOfferCard

### Community 391 - "package:dio/dio.dart"
Cohesion: 0.04
Nodes (53): Completer, Dio, ApiException, dio, _isRefreshingToken, message, null, _refreshCompleter (+45 more)

### Community 392 - "static const Color"
Cohesion: 0.04
Nodes (50): dart:math, donut_capacity_painter.dart, bestTokenFuzzyDistance, damerauLevenshtein, FuzzyMatcher, isFuzzyMatch, similarityScore, AdminOrdersEmptyView (+42 more)
...
### Community 395 - "admin_order_card.dart"
Cohesion: 0.03
Nodes (83): bool?, ../core/config/app_config.dart, ../../core/services/admin_notification_service.dart, ../core/theme/responsive.dart, ../data/models/order.dart, availableRiders, color, formatOrderTime (+75 more)
...
Cohesion: 0.04
Nodes (62): DeliveryHeader(), DeliveryHeaderProps, LiveClock(), HandoverConfirmModal(), HandoverConfirmModalProps, ProductPage(), AdminAlerts(), AdminAlertsProps (+54 more)
...
### Community 409 - "auth_provider.dart"
Cohesion: 0.06
Nodes (31): address_provider.dart, cart_provider.dart, core/routes/app_router.dart, core/services/deep_link_service.dart, ../core/services/notification_service.dart, ../core/services/secure_storage_service.dart, core/theme/app_theme.dart, android (+23 more)

### Community 415 - "add_review_screen.dart"
Cohesion: 0.18
...
### Community 421 - "../providers/address_provider.dart"
Cohesion: 0.25
Nodes (8): AddressesScreen, build, _buildAddressCard, _iconForLabel, addressRepositoryProvider, ../providers/address_provider.dart, ../../widgets/app_confirmation_dialog.dart, ../../widgets/brand_card.dart
...
### Community 440 - "order_repository.dart"
Cohesion: 0.05
Nodes (41): ../../core/services/admin_authorization.dart, dart:convert, dart:io, AdminNotificationService, fireAdminWhatsAppAlert, formatOrderWhatsAppMessage, formatRestaurantKOTMessage, sendSubstitutionWhatsApp (+33 more)
...
### Community 447 - "check-store/route.ts"
Cohesion: 0.83
Nodes (3): calculateDistanceKm(), GET(), isPointInPolygon()

### Community 448 - "VoidCallback?"
Cohesion: 0.04
Nodes (50): ../../../core/utils/validators.dart, AddressCard, build, fullAddress, isSelected, label, onTap, actionLabel (+42 more)

### Community 449 - "gemini-cards/route.ts"
Cohesion: 0.67
Nodes (3): AESTHETIC_PHOTOS, getPhotoPool(), POST()

### Community 451 - "app/error.tsx"
Cohesion: 0.48
...
## Knowledge Gaps
- **5275 isolated node(s):** `$schema`, `style`, `rsc`, `tsx`, `config` (+5270 more)
...
- **Why does `dependencies` connect `dependencies` to `fcm.py`, `package.json`, `clsx`, `tailwindcss`, `@types/node`, `xlsx`, `@types/react-dom`, `react-dom`, `@prisma/adapter-pg`, `dotenv`, `date-fns`, `framer-motion`, `@google/genai`, `lru-cache`, `next`, `prisma`, `@prisma/client`, `shadcn`, `@types/papaparse`, `@types/pg`, `zod`, `next-auth`, `sonner`, `papaparse`, `@tailwindcss/postcss`, `lucide-react`, `resend`, `@types/web-push`, `web-push`, `@auth/prisma-adapter`, `zustand`?**
...
- **Should `prisma.ts` be split into smaller, more focused modules?**
  _Cohesion score 0.03257080610021786 - nodes in this community are weakly interconnected._
