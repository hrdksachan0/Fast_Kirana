...
## Corpus Check
- 805 files · ~3,547,742 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7827 nodes · 13564 edges · 381 communities (306 shown, 75 thin omitted)
...
Cohesion: 0.03
Nodes (77): ../core/theme/design_system.dart, ../data/repositories/product_repository.dart, delivery_dashboard.dart, AboutScreen, build, _divider, _linkItem, _statBox (+69 more)
...
### Community 5 - "cn"
Cohesion: 0.05
Nodes (56): RootLayout(), AccountDashboard(), AccountDashboardProps, WishlistClient(), WishlistItem, RestaurantManager(), RestaurantManagerProps, SlideToOrder() (+48 more)
...
Cohesion: 0.04
Nodes (50): , ../categories/category_products_screen.dart, _buildActiveDeliveryTracker, _buildCategoryAvatarImage, _buildCategoryFallback, _buildCategoryToggle, _buildFoodGreetingBanner, _buildFooter (+42 more)
...
Cohesion: 0.05
Nodes (44): DeliveryHeader(), DeliveryHeaderProps, LiveClock(), AdminAlerts(), AdminAlertsProps, AlertItem, Counts, AdminInward() (+36 more)

### Community 15 - "address_provider.dart"
Cohesion: 0.13
Nodes (14): ../data/repositories/address_repository.dart, AddressRepository, AddressesScreen, _buildAddressCard, addAddress, addressesAsync, addressRepositoryProvider, clear (+6 more)

### Community 16 - "restaurant-orders-console.tsx"
Cohesion: 0.05
Nodes (54): CodPaymentModal(), CodPaymentModalProps, ModalStep, RiderWalletView(), RiderWalletViewProps, DeliveryDashboard(), optimizeRoute(), triggerConfetti() (+46 more)
...
Cohesion: 0.04
Nodes (63): dynamic, findRestaurantBySlug(), FoodRestaurantPage(), generateMetadata(), AdminBulkUpdate(), AdminBulkUpdateProps, BatchHistory, Category (+55 more)
...
Cohesion: 0.03
Nodes (82): cart_conflict_dialog.dart, ../checkout/checkout_screen.dart, ../core/services/location_service.dart, ../core/utils/dish_timing.dart, ../core/utils/restaurant_utils.dart, coupons_screen.dart, _auth, authenticate (+74 more)
...
Cohesion: 0.10
Nodes (29): build, build, build, build, build, build, _buildApiProductSections, _buildCategoryBentoFeed (+21 more)

### Community 35 - "triggerHaptic"
Cohesion: 0.05
Nodes (47): UpiQrModal(), loadQrData(), UpiQrModalProps, Error(), AdminForecast(), AdminForecastProps, ForecastItem, ForecastTab() (+39 more)
...
Cohesion: 0.05
Nodes (35): ../cart/cart_screen.dart, ../data/models/product.dart, _buildEmptyState, _buildSearchBox, _buildSegmentedTabs, _buildStatusFilterPills, createState, dispose (+27 more)
...
Cohesion: 0.03
Nodes (70): ../core/config/app_config.dart, ../../../core/services/battery_optimization_service.dart, ../data/models/address.dart, BatteryOptimizationDialog, build, _buildStepRow, onDismissed, showIfNecessary (+62 more)
...
Cohesion: 0.08
Nodes (25): _buildFilterPill, category, CategoryProductsScreen, _CategoryProductsScreenState, createState, dispose, emoji, id (+17 more)
...
Cohesion: 0.04
Nodes (45): ../common/order_edit_modal.dart, ../core/utils/app_connectivity.dart, connectivityProvider, _autoRefreshTimer, bgMain, brandGreen, brandOrange, _buildLiveClockMetric (+37 more)

### Community 104 - "dioProvider"
Cohesion: 0.04
Nodes (82): ConsumerState, ConsumerStatefulWidget, DeliveryLoginScreen, dioProvider, _assignRider, _fetchAdminOrders, _fetchDeliveryRiders, _flushOfflineAdminQueue (+74 more)
...
Cohesion: 0.05
Nodes (84): CartPage(), jakarta, metadata, viewport, SupabaseAuthBridge(), CartConflictDialog(), CartDrawer(), CartStickyBar() (+76 more)
...
Cohesion: 0.03
Nodes (67): build, createState, _currentPage, dispose, _navigateToLogin, OnboardingScreen, _OnboardingScreenState, _pageController (+59 more)
...
Cohesion: 0.04
Nodes (57): ConfettiController, ../../core/services/logger_service.dart, dart:async, dart:math, ../data/repositories/order_repository.dart, NetworkRetryHelper, _animController, _buildDetailRow (+49 more)
...
### Community 132 - "SingleTickerProviderStateMixin"
Cohesion: 0.12
Nodes (15): ../data/models/banner.dart, ../data/repositories/banner_repository.dart, BannerRepository, _AnimatedStepNode, _AnimatedStepNodeState, build, OrderTrackingScreen, _OrderTrackingScreenState (+7 more)
...
Cohesion: 0.02
Nodes (127): address_book_screen.dart, address_provider.dart, ../admin/admin_dashboard.dart, ../auth/login_screen.dart, ../cafe/restaurant_dashboard.dart, cart_provider.dart, ../categories/categories_screen.dart, ../core/network/api_client.dart (+119 more)
...
Cohesion: 0.13
Nodes (14): ../data/repositories/wishlist_repository.dart, addToWishlist, dio, getWishlist, _handleError, removeFromWishlist, WishlistRepository, isInWishlist (+6 more)
...
### Community 157 - "categories_screen.dart"
Cohesion: 0.11
Nodes (18): CategoriesScreen, category_products_screen.dart, ../data/models/category.dart, build, _buildReferenceCategoryCard, CategoriesScreen, _CategoriesScreenState, createState (+10 more)

### Community 158 - "store_hub_provider.dart"
Cohesion: 0.11
Nodes (17): ../core/services/supabase_service.dart, ../data/models/store_hub.dart, activeStoreHubsProvider, address, customerLat, customerLng, distanceKm, hub (+9 more)

### Community 161 - "package:flutter/foundation.dart"
Cohesion: 0.06
Nodes (33): dart:convert, dart:io, ../data/models/order.dart, AdminNotificationService, fireAdminWhatsAppAlert, formatOrderWhatsAppMessage, formatRestaurantKOTMessage, sendSubstitutionWhatsApp (+25 more)

### Community 173 - "authProvider"
Cohesion: 0.06
Nodes (50): _handleLogout, _loadSettings, _buildAdminOrderCard, _handleVerifyOtp, build, _initOutletDetails, _showKOTPrintModal, _buildBottomCheckoutBar (+42 more)
...
### Community 254 - "brand_input.dart"
Cohesion: 0.15
...
Cohesion: 0.05
Nodes (54): ConsumerWidget, FadeSlideRoute, deliveryTierProvider, _handleContinue, _buildDishAddButton, _buildMenuTab, _buildRestaurantDishItem, _buildReviewsTab (+46 more)
...
Cohesion: 0.02
Nodes (117): BorderRadius?, BoxShape, DishTimingStatus, double?, EdgeInsets?, AdminCustomersScreen, _StatusDropdownItem, backgroundColor (+109 more)
...
Cohesion: 0.03
Nodes (69): Color?, build, _buildTncSection, createState, dispose, _errorMessage, _focusNode, _handleSkipGuest (+61 more)

### Community 328 - "auth/splash_screen.dart"
Cohesion: 0.15
...
Cohesion: 0.02
Nodes (153): CheckoutCouponInput(), CouponInputProps, CheckoutDeliverySelector(), DeliverySelectorProps, CheckoutOrderSummary(), OrderSummaryProps, ActiveDeliveryCard(), ActiveDeliveryCardProps (+145 more)
...
## Knowledge Gaps
- **4317 isolated node(s):** `$schema`, `style`, `rsc`, `tsx`, `config` (+4312 more)
...
- **What connects `$schema`, `style`, `rsc` to the rest of the system?**
  _4317 weakly-connected nodes found - possible documentation gaps or missing edges._
