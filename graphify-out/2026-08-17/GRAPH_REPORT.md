# Graph Report - Fastkirana  (2026-08-17)

## Corpus Check
- 588 files · ~2,567,509 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4743 nodes · 8012 edges · 306 communities (247 shown, 59 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 218 edges (avg confidence: 0.52)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f2c16555`
...
## Communities (306 total, 59 thin omitted)

### Community 0 - "package:flutter/material.dart"
Cohesion: 0.02
Nodes (128): BorderRadius?, category_products_screen.dart, ../constants/app_colors.dart, ../core/theme/design_system.dart, design_system.dart, AppTheme, AboutScreen, build (+120 more)

### Community 1 - "admin_extended.py"
Cohesion: 0.05
Nodes (91): Banner, Category, Product, admin_block_user(), admin_bulk_import_products(), admin_bulk_sort_products(), admin_bulk_update(), admin_create_banner() (+83 more)
...
### Community 3 - "auth"
Cohesion: 0.05
Nodes (53): WishlistPage(), AdminRestaurantsPage(), revalidate, DELETE(), GET(), PATCH(), POST(), PUT() (+45 more)

### Community 4 - "index.ts"
Cohesion: 0.05
Nodes (38): revalidate, revalidate, SearchPage(), SearchPageProps, CategoriesDirectoryClient(), CategoriesDirectoryClientProps, CategoryConfig, CategoryPageClientProps (+30 more)

### Community 5 - "cn"
Cohesion: 0.05
Nodes (59): iconMap, ProductPage(), ProductPageProps, revalidate, AccountDashboardProps, WishlistClient(), WishlistItem, RestaurantManager() (+51 more)

### Community 6 - "package:flutter_riverpod/flutter_riverpod.dart"
Cohesion: 0.03
Nodes (72): CategoriesScreen, Category, ConsumerWidget, ../data/models/category.dart, ../data/models/product.dart, ../data/repositories/product_repository.dart, build, _buildCategoryCard (+64 more)

### Community 7 - "home_screen.dart"
Cohesion: 0.03
Nodes (73): ../cafe/cafe_menu_screen.dart, ../categories/categories_screen.dart, dart:async, dart:ui, _buildFoodItemCard, build, _buildCartContent, _buildCartItemRow (+65 more)

### Community 8 - "useUIStore"
Cohesion: 0.09
Nodes (54): CartPage(), CartConflictDialog(), CartDrawer(), CartStickyBar(), BuyAgainItem, BuyAgainSection(), Category, FeaturedCategoryCard() (+46 more)

### Community 9 - "restaurant-orders-console.tsx"
Cohesion: 0.07
Nodes (39): CodPaymentModal(), CodPaymentModalProps, DeliveryHeader(), DeliveryHeaderProps, LiveClock(), RiderWalletView(), RiderWalletViewProps, DeliveryDashboard() (+31 more)

### Community 10 - "prisma"
Cohesion: 0.09
Nodes (30): POST(), POST(), GET(), POST(), POST(), GET(), GET(), PATCH() (+22 more)
...
Cohesion: 0.05
Nodes (49): CategoryPage(), CategoryPageProps, revalidate, CheckoutCouponInput(), CouponInputProps, CheckoutDeliverySelector(), DeliverySelectorProps, CheckoutOrderSummary() (+41 more)

### Community 15 - "admin_login.dart"
Cohesion: 0.04
Nodes (49): address_book_screen.dart, ../admin/admin_dashboard.dart, admin_login.dart, ../../core/config/app_config.dart, core/routes/app_router.dart, core/theme/app_theme.dart, ../../data/repositories/auth_repository.dart, AdminLoginScreen (+41 more)

### Community 16 - "product_card.dart"
Cohesion: 0.08
Nodes (26): ../cart/cart_screen.dart, _buildQualityRow, createState, _isFavorite, primaryRed, product, ProductDetailScreen, _ProductDetailScreenState (+18 more)
...
Cohesion: 0.07
Nodes (28): jakarta, metadata, RootLayout(), viewport, Footer(), Logo(), LogoProps, MainWrapper() (+20 more)
...
### Community 23 - "cart.py"
Cohesion: 0.19
Nodes (23): Cart, CartItem, add_to_cart(), clear_cart(), generate_id(), get_cart(), get_or_create_guest_user(), get_user_id() (+15 more)

### Community 24 - "jwt.py"
Cohesion: 0.07
Nodes (35): get_current_user(), Any, HTTPAuthorizationCredentials, JWT authentication middleware for FastAPI. Validates NextAuth.js JWT tokens and…, Create a dependency that requires specific role(s). Usage:…, Require access to a specific order (owner or staff). Usage: await…, Extract and validate current user from JWT token. Returns: User dict with {id,…, Require authenticated user. Raises: HTTPException 401 if not authenticated (+27 more)
...
Cohesion: 0.09
Nodes (41): User, check_email(), generate_otp(), get_me(), get_session(), hash_password(), login(), LoginRequest (+33 more)
...
Cohesion: 0.09
Nodes (17): AdminSettings(), AdminSettingsProps, SettingsTab(), SettingsTabProps, CAFE_FREE_DELIVERY_THRESHOLD, CAFE_PICKUP_ADDRESS, COMBINED_FREE_DELIVERY_THRESHOLD, DELIVERY_FEE (+9 more)
...
### Community 31 - "restaurant-kitchen/page.tsx"
Cohesion: 0.10
Nodes (22): RestaurantKitchenPage(), AdminRestaurantConsole(), AdminRestaurantConsoleProps, Product, Category, Product, RestaurantCatalogManager(), getCafeSectionImage() (+14 more)
...
Cohesion: 0.08
Nodes (22): AdminDashboardProps, TabType, CategoriesTab(), CategoriesTabProps, CategoryWithCount, DashboardStats, DashboardStatsCards(), DashboardStatsCardsProps (+14 more)
...
Cohesion: 0.13
Nodes (13): GET(), getFuzzyScore(), getLevenshteinDistance(), SYNONYM_DICTIONARY, DELETE(), POST(), OUTLET_AS_RESTAURANT_ID, OUTLET_WEDSON_ID (+5 more)
...
Cohesion: 0.06
Nodes (31): @base-ui/react, bcryptjs, class-variance-authority, clsx, lru-cache, next-auth, nodemailer, dependencies (+23 more)
...
Cohesion: 0.11
Nodes (21): get_db(), AsyncSession, Database initialization script. Run with: python init_db.py, Address, create_address(), delete_address(), generate_id(), get_user_addresses() (+13 more)
...
### Community 60 - "triggerHaptic"
Cohesion: 0.10
Nodes (27): Error(), AdminForecast(), AdminForecastProps, ForecastItem, CUISINES, FoodMarketplace(), FoodMarketplaceProps, SortOption (+19 more)

### Community 61 - "auth_provider.dart"
Cohesion: 0.18
Nodes (10): dart:convert, ../data/models/user.dart, auth, clear, currentUserProvider, _load, maybeWhen, setUser (+2 more)
...
Cohesion: 0.08
Nodes (37): Base, CashDepositTransaction, Coupon, InventoryLog, OrderItem, PayoutRequest, Restaurant, Review (+29 more)

### Community 64 - "orders_helper.py"
Cohesion: 0.20
...
### Community 76 - "checkout_screen.dart"
Cohesion: 0.09
...
Cohesion: 0.23
Nodes (9): AdminPage(), revalidate, GET(), GET(), OrderConfirmPage(), OrderConfirmPageProps, AdminDashboard(), formatDate() (+1 more)
...
### Community 100 - "create-order-modal.tsx"
Cohesion: 0.10
Nodes (18): BlockCustomerModal(), BlockCustomerModalProps, Category, CategoryEditModal(), CategoryEditModalProps, Address, CreateOrderModal(), CreateOrderModalProps (+10 more)

### Community 101 - "High-Agency Frontend Skill"
Cohesion: 0.06
Nodes (30): 10. FINAL PRE-FLIGHT CHECK, 1. ACTIVE BASELINE CONFIGURATION, 2. DEFAULT ARCHITECTURE & CONVENTIONS, 3. DESIGN ENGINEERING DIRECTIVES (Bias Correction), 4. CREATIVE PROACTIVITY (Anti-Slop Implementation), 5. PERFORMANCE GUARDRAILS, 6. TECHNICAL REFERENCE (Dial Definitions), 7. AI TELLS (Forbidden Patterns) (+22 more)

### Community 102 - "new-work.md"
Cohesion: 0.08
...
### Community 105 - "date-helpers.ts"
Cohesion: 0.06
Nodes (34): DeliveryHistoryView(), DeliveryHistoryViewProps, dynamic, OrderTrackingPageProps, AdminRiderCash(), DepositLog, RiderCashInfo, SummaryInfo (+26 more)
...
### Community 114 - "admin-banners.tsx"
Cohesion: 0.20
...
### Community 121 - "prisma.ts"
Cohesion: 0.06
Nodes (13): dynamic, GET(), revalidate, dynamic, GET(), revalidate, GET(), GET() (+5 more)
...
### Community 145 - "push-notifications-tab.tsx"
Cohesion: 0.40
...
### Community 153 - "Adaptation Strategies"
Cohesion: 0.40
...
### Community 154 - "master-lookup/route.ts"
Cohesion: 0.50
...
### Community 157 - "widget_test.dart"
Cohesion: 0.50
...
### Community 185 - "address_book_screen.dart"
Cohesion: 0.13
...
## Knowledge Gaps
- **2425 isolated node(s):** `$schema`, `style`, `rsc`, `tsx`, `config` (+2420 more)
...
- **Why does `dependencies` connect `dependencies` to `@types/papaparse`, `date-fns`, `framer-motion`, `lucide-react`, `react`, `react-dom`, `shadcn`, `sonner`, `@types/pg`, `@auth/prisma-adapter`, `next`, `@types/react`, `xlsx`, `papaparse`, `@prisma/client`, `resend`, `tailwindcss`, `@types/react-dom`, `@types/web-push`, `libphonenumber-js`, `config.py`, `prisma`, `tailwind-merge`, `package.json`?**
...
- **Should `package:flutter/material.dart` be split into smaller, more focused modules?**
  _Cohesion score 0.02075285919866697 - nodes in this community are weakly interconnected._
