# Graph Report - Fastkirana  (2026-09-17)

## Corpus Check
- 908 files · ~3,259,604 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8537 nodes · 14969 edges · 439 communities (360 shown, 79 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 350 edges (avg confidence: 0.52)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c9ea8e5c`
...
6. `formatPrice()` - 88 edges
7. `triggerHaptic()` - 74 edges
8. `getLast10Digits()` - 57 edges
...
## Communities (439 total, 79 thin omitted)

### Community 0 - "package:flutter/material.dart"
Cohesion: 0.03
Nodes (70): ../core/theme/design_system.dart, delivery_dashboard.dart, AboutScreen, build, _divider, _linkItem, _statBox, AdminBannersScreen (+62 more)
...
Cohesion: 0.04
Nodes (75): GET(), PATCH(), POST(), PUT(), DELETE(), GET(), POST(), PUT() (+67 more)
...
### Community 5 - "cn"
Cohesion: 0.05
Nodes (53): RootLayout(), AccountDashboardProps, WishlistClient(), WishlistItem, RestaurantManager(), RestaurantManagerProps, OrderForSomeoneCard(), OrderForSomeoneCardProps (+45 more)
...
Cohesion: 0.04
Nodes (74): dynamic, revalidate, CategoryPage(), CategoryPageProps, revalidate, getCachedAllGroceryProducts, getCachedBanners, getCachedBestSellers (+66 more)
...
Cohesion: 0.08
Nodes (31): HandoverConfirmModal(), HandoverConfirmModalProps, EmptyCartScreen(), InventoryIssueScreen(), InventoryIssueScreenProps, StoreClosedScreen(), StoreClosedScreenProps, CheckoutBillSummary() (+23 more)
...
Cohesion: 0.02
Nodes (87): BitmapDescriptor?, _audioPlayer, brandGreen, _calculateBearing, _calculateETA, _cfService, _checkAndRequestLocationPermission, _collectTrackingChannelKeys (+79 more)

### Community 14 - "address_selector_sheet.dart"
Cohesion: 0.04
Nodes (48): Address?, ../core/services/location_service.dart, DeliveryTierInfo, LocationDetails, _Address, build, _buildRow, CheckoutBillBreakdown (+40 more)

### Community 15 - "rider_active_delivery_card.dart"
Cohesion: 0.06
...
### Community 16 - "category_products_screen.dart"
Cohesion: 0.03
Nodes (69): category_products_screen.dart, ../core/routes/page_transitions.dart, ../../core/widgets/loading_widgets.dart, ../data/models/category.dart, ../data/models/product.dart, ../data/repositories/product_repository.dart, build, _categories (+61 more)
...
Cohesion: 0.05
Nodes (38): CartItem, ../../../core/services/battery_optimization_service.dart, ../data/models/cart.dart, CachedMapTileProvider, customHeaders, getImage, build, isUpdating (+30 more)
...
Cohesion: 0.04
Nodes (61): ../checkout/checkout_screen.dart, coupons_screen.dart, deliveryTierProvider, _appliedCoupon, _applyCoupon, brandGreen, build, _buildBillDetailsCard (+53 more)

### Community 24 - "api/products/route.ts"
Cohesion: 0.06
Nodes (37): GET(), GET(), GET(), GET(), getFuzzyScore(), getLevenshteinDistance(), SYNONYM_DICTIONARY, DEFAULT_CAFE_SECTIONS (+29 more)

### Community 25 - "checkout.ts"
Cohesion: 0.05
Nodes (64): GET(), CheckoutAddressForm(), CheckoutAddressFormProps, CheckoutAddressSectionProps, LocationPicker, FreeMapPicker(), FreeMapPickerProps, loadLeaflet() (+56 more)
...
### Community 31 - "List"
Cohesion: 0.06
Nodes (31): build, createState, _currentPage, dispose, _navigateToLogin, _pageController, _pages, bgMain (+23 more)

### Community 32 - "dart:async"
Cohesion: 0.04
Nodes (52): address_provider.dart, cart_provider.dart, core/routes/app_router.dart, core/services/deep_link_service.dart, ../core/services/notification_service.dart, ../core/services/secure_storage_service.dart, ../core/services/supabase_service.dart, core/theme/app_theme.dart (+44 more)

### Community 33 - "compilerOptions"
Cohesion: 0.06
Nodes (34): check_all_products.ts, dom, dom.iterable, esnext, fastkirana_flutter, **/*.mts, .next/dev, .next/dev/types/**/*.ts (+26 more)

### Community 34 - "grocery_delivery_loading_screen.dart"
Cohesion: 0.10
Nodes (21): autoDismissDuration, build, _buildGroceryIllustration, createState, _CuteGroceryVectorPainter, dispose, _fadeAnim, _fadeController (+13 more)

### Community 35 - "package:dio/dio.dart"
Cohesion: 0.07
Nodes (30): Completer, ../data/repositories/wishlist_repository.dart, Dio, ApiException, dio, _isRefreshingToken, message, null (+22 more)
...
Cohesion: 0.07
Nodes (29): @base-ui/react, clsx, date-fns, lru-cache, next, dependencies, @base-ui/react, clsx (+21 more)

### Community 40 - "delivery_dashboard.dart"
Cohesion: 0.02
Nodes (101): ../../core/services/rider_location_service.dart, _activeTab, _assignedStoreId, _assignedStoreName, _audioPlayer, _autoRefreshTimer, bgMain, borderCol (+93 more)

### Community 41 - "triggerHaptic"
Cohesion: 0.05
Nodes (50): UpiQrModal(), loadQrData(), UpiQrModalProps, Error(), AdminForecast(), AdminForecastProps, ForecastItem, FoodPackagingSelector() (+42 more)
...
### Community 43 - "useUIStore"
Cohesion: 0.06
Nodes (72): CartPage(), CheckoutPage(), jakarta, metadata, viewport, CartConflictDialog(), CartDrawer(), CartStickyBar() (+64 more)
...
Cohesion: 0.03
Nodes (64): ../core/theme/responsive.dart, EdgeInsets, AppToast, _show, showError, showInfo, showSuccess, showWarning (+56 more)
...
### Community 60 - "admin_authorization.dart"
Cohesion: 0.15
...
Cohesion: 0.07
Nodes (38): computeNewValue(), DELETE(), generateBatchId(), GET(), POST(), POST(), slugify(), PATCH() (+30 more)
...
Cohesion: 0.05
Nodes (39): AudioPlayer, ../core/utils/app_connectivity.dart, _auth, authenticate, BiometricService, getAvailableBiometrics, isBiometricAvailable, _activeOrderId (+31 more)
...
### Community 72 - "login_screen.dart"
Cohesion: 0.11
...
Cohesion: 0.04
Nodes (50): ../data/models/store_hub.dart, area, baseFee, cart, city, deliveryFee, distanceKm, feeDescription (+42 more)

### Community 79 - "doorstep_details_screen.dart"
Cohesion: 0.04
Nodes (54): ../admin/admin_dashboard.dart, _handleLogout, AdminLoginScreen, _AdminLoginScreenState, build, createState, dispose, _emailController (+46 more)
...
### Community 86 - "app/routers/products.py"
Cohesion: 0.17
Nodes (11): Category, Base, Product, Base, get_categories(), get, get_product(), get_products() (+3 more)

### Community 87 - "FadeSlideRoute"
Cohesion: 0.06
Nodes (44): ../../categories/category_products_screen.dart, CategoriesScreen, FadeSlideRoute, _handleContinue, _buildMenuTab, _buildReviewsTab, build, _CategoriesScreenState (+36 more)
...
### Community 90 - "cart_repository.dart"
Cohesion: 0.13
Nodes (14): applyCoupon, clearCart, dio, getCart, _getCartCacheKey, getLocalCart, _handleError, hasPendingSync (+6 more)

### Community 91 - "restaurant-report.service.ts"
Cohesion: 0.17
Nodes (10): calculateDistanceKm(), GET(), isPointInPolygon(), DailySalesTrend, ItemRow, OrderRow, RestaurantReportData, RestaurantReportService (+2 more)
...
Cohesion: 0.04
Nodes (55): _activeCategoryTag, _buildCategories, _buildCategoryThumbnail, _buildFallbackBanner, _buildFallbackLogo, _buildLocalAssetOrEmoji, _buildLogoWidget, _buildRestaurantBanner (+47 more)

### Community 98 - "lib/widgets/empty_state.dart"
Cohesion: 0.04
Nodes (47): Color?, AdminStatCard, bgColor, borderColor, build, icon, iconColor, subtitle (+39 more)
...
Cohesion: 0.04
Nodes (44): AdminAlerts(), AdminDashboard(), AdminDashboardProps, CategoryEditModal, CreateOrderModal, TabType, AlertsTab(), AlertsTabProps (+36 more)
...
Cohesion: 0.08
Nodes (27): build, bannersProvider, _advanceToNext, _autoSlideTimer, build, _buildBannerCard, _buildShimmerPlaceholder, createState (+19 more)
...
Cohesion: 0.05
Nodes (40): AdminBulkUpdate(), AdminBulkUpdateProps, BatchHistory, Category, ChangePreview, Product, AdminRestaurantConsole(), AdminRestaurantConsoleProps (+32 more)
...
Cohesion: 0.07
Nodes (28): ../../../core/utils/app_toast.dart, build, CheckoutPackagingSelector, onPackagingChanged, selectedPackaging, AddItemSearchSheet, _AddItemSearchSheetState, _adminCatalogFilter (+20 more)
...
### Community 110 - "core/database.py"
Cohesion: 0.17
Nodes (15): Settings, get_db(), CurrentUser, get_current_user(), Order, OrderItem, Base, get_order_details() (+7 more)

### Community 111 - "StatelessWidget"
Cohesion: 0.04
Nodes (56): BoxShape, double?, AppShimmer, build, child, count, OrderCardShimmer, ProductCardShimmer (+48 more)

### Community 112 - "seed.ts"
Cohesion: 0.33
Nodes (4): adapter, pool, prisma, NOTE: We do NOT delete any products, categories, or orders.

### Community 113 - "search_screen.dart"
Cohesion: 0.05
Nodes (46): empty_state.dart, widgets, _buildFilterPill, createState, _cuisineCategories, dispose, RestaurantsListScreen, _searchController (+38 more)
...
Cohesion: 0.09
Nodes (41): POST(), POST(), POST(), POST(), POST(), PATCH(), PUT, STAFF_ROLES (+33 more)
...
Cohesion: 0.04
Nodes (47): ConfettiController, ../data/repositories/order_repository.dart, _animController, _buildDetailRow, _buildProgressLine, _buildProgressStep, _buttonsFadeAnim, _buttonsSlideAnim (+39 more)

### Community 121 - "add_restaurant_product_modal.dart"
Cohesion: 0.03
Nodes (59): class, AddRestaurantProductModal, _AddRestaurantProductModalState, _buildFoodTypeOption, createState, _descriptionController, dispose, _fetchRestaurantSections (+51 more)
...
Cohesion: 0.03
Nodes (61): address_book_screen.dart, ../auth/login_screen.dart, ../cafe/restaurant_dashboard.dart, ../categories/categories_screen.dart, ../core/network/api_client.dart, ../delivery/delivery_dashboard.dart, ../delivery/picker_dashboard.dart, brandGreen (+53 more)
...
Cohesion: 0.09
Nodes (28): AdminPage(), revalidate, AdminRestaurantsPage(), revalidate, GET(), checkAdmin(), GET(), PATCH() (+20 more)

### Community 141 - "auth"
Cohesion: 0.04
Nodes (62): WishlistPage(), EditRestaurantPage(), NewRestaurantPage(), DELETE(), dynamic, GET(), POST(), GET() (+54 more)
...
### Community 154 - "superadmin-config.ts"
Cohesion: 0.11
...
### Community 161 - "selectedAddressProvider"
Cohesion: 0.11
...
Cohesion: 0.22
Nodes (15): dynamic, GET(), POST(), POST(), CashfreeOrderResponse, CashfreePaymentRecord, CashfreeUpiQrResult, checkCashfreeOrderPaid() (+7 more)
...
### Community 185 - "app/routers/cart.py"
Cohesion: 0.20
Nodes (15): Cart, CartItem, Base, get_cart(), get, post, sync_cart(), CartItemIn (+7 more)
...
### Community 190 - "admin_order_card.dart"
Cohesion: 0.05
Nodes (41): bool?, ../data/models/order.dart, availableRiders, color, formatOrderTime, getStatusColor, icon, isKOTPrinted (+33 more)
...
### Community 233 - "product_detail_screen.dart"
Cohesion: 0.05
Nodes (46): ../cart/cart_screen.dart, cart_conflict_dialog.dart, ../core/utils/dish_timing.dart, ../core/utils/restaurant_utils.dart, ../data/models/store_settings.dart, _loadSettings, build, _buildBottomCheckoutBar (+38 more)
...
### Community 254 - "privacy_policy_screen.dart"
Cohesion: 0.12
...
### Community 284 - "orders_helper.py"
Cohesion: 0.20
...
### Community 294 - "tracking_status_stepper.dart"
Cohesion: 0.09
...
### Community 295 - "product_provider.dart"
Cohesion: 0.10
...
### Community 302 - "banner_repository.dart"
Cohesion: 0.09
Nodes (21): dart:convert, clearQueue, enqueueAction, flushQueue, getPendingCount, hasPendingActions, OfflineSyncService, queueAdmin (+13 more)
...
### Community 310 - "ConsumerState"
Cohesion: 0.05
Nodes (54): admin_orders_list.dart, admin_products.dart, ConsumerState, ConsumerStatefulWidget, DeliveryLoginScreen, AdminDashboard, _AdminDashboardState, _buildDockItem (+46 more)
...
Cohesion: 0.09
Nodes (32): AccountPage(), dynamic, revalidate, POST(), GET(), PATCH(), POST(), POST() (+24 more)
...
### Community 319 - "State"
Cohesion: 0.21
Nodes (12): ContextualBrandTransitionScreen, _ContextualBrandTransitionScreenState, OnboardingScreen, _OnboardingScreenState, SplashScreen, RestaurantMenuCatalogTab, _RestaurantMenuCatalogTabState, _AreaSearchModal (+4 more)
...
### Community 323 - "orders_service.py"
Cohesion: 0.20
...
### Community 328 - "restaurant_delivery_loading_screen.dart"
Cohesion: 0.10
...
### Community 333 - "storefront-client.tsx"
Cohesion: 0.05
Nodes (37): DealsCurationHub(), DealsCurationHubProps, PremiumBreakfastIcon(), PremiumEssentialsIcon(), PremiumLateNightIcon(), PremiumLightningDealsIcon(), PremiumLunchIcon(), PremiumSnacksIcon() (+29 more)
...
### Community 335 - "live_gps_route_card.dart"
Cohesion: 0.10
...
Cohesion: 0.03
Nodes (108): CheckoutCouponInput(), CouponInputProps, CheckoutDeliverySelector(), DeliverySelectorProps, CheckoutOrderSummary(), OrderSummaryProps, ActiveDeliveryCard(), ActiveDeliveryCardProps (+100 more)

### Community 337 - "app/routers/banners.py"
Cohesion: 0.28
Nodes (6): PromoBanner, Base, get_banners(), get, PromoBannerOut, BaseModel

### Community 338 - "upload/route.ts"
Cohesion: 0.52
...
### Community 344 - "tracking_map_view.dart"
Cohesion: 0.11
...
### Community 347 - "offline_cart_sync_test.dart"
Cohesion: 0.13
Nodes (16): CartRepository, main, main, _makeGrocery, makeNotifier, cartRepo, main, makeTestProduct (+8 more)
...
### Community 351 - "order_detail_screen.dart"
Cohesion: 0.07
Nodes (27): build, _buildBillRow, _buildPayOnlineCard, _buildStatusHeaderCard, _buildTimelineStep, _getStatusBg, _getStatusColor, _getStatusStepIndex (+19 more)
...
### Community 354 - "delivery_location_screen.dart"
Cohesion: 0.11
Nodes (18): autoFetchLocation, _checkAndAutoPromptLocation, createState, DeliveryLocationScreen, _DeliveryLocationScreenState, dispose, _getAddressIcon, _handleBack (+10 more)

### Community 355 - "brand_button.dart"
Cohesion: 0.12
...
### Community 360 - "address_provider.dart"
Cohesion: 0.10
...
### Community 364 - "AnimationController"
Cohesion: 0.13
Nodes (14): Animation, AnimationController, build, _controller, createState, dispose, _fadeAnimation, initState (+6 more)

### Community 366 - "restaurant_card.dart"
Cohesion: 0.14
Nodes (14): ../data/models/restaurant.dart, _buildDefaultFallback, _buildImagePlaceholder, _buildLocalOrFallbackImage, _buildRestaurantImage, _bundledCategoryAssets, createState, _isFavorite (+6 more)
...
### Community 369 - "orders_screen.dart"
Cohesion: 0.06
Nodes (39): ConsumerWidget, AdminOrderCard, build, build, _buildEmptyState, _buildSearchBox, _buildSegmentedTabs, _buildStatusFilterPills (+31 more)
...
### Community 377 - "store-hubs-manager.tsx"
Cohesion: 0.50
Nodes (3): StoreHub, StoreHubsManager(), StoreHubsManagerProps

### Community 378 - "subscription_screen.dart"
Cohesion: 0.15
...
Cohesion: 0.06
Nodes (50): RestaurantKitchenPage(), OrdersTab(), OrdersTabProps, CompanionOrder, containerVariants, foodEmojis, formatElapsed(), getItemEmoji() (+42 more)

### Community 388 - "restaurantsProvider"
Cohesion: 0.21
...
### Community 390 - "brand_input.dart"
Cohesion: 0.17
...
### Community 397 - "map_marker_generator.dart"
Cohesion: 0.20
...
### Community 398 - "cart_savings_banner.dart"
Cohesion: 0.20
...
### Community 418 - "schemas/order.py"
Cohesion: 0.53
Nodes (5): OrderCreateIn, OrderItemIn, OrderItemOut, OrderOut, BaseModel

### Community 420 - "review-edit-modal.tsx"
Cohesion: 0.40
Nodes (3): ReviewEditModal, Review, ReviewEditModalProps

### Community 426 - "Impeccable Documenter"
Cohesion: 0.40
Nodes (4): Impeccable Documenter, Input Contract, Output Contract, Workflow

### Community 427 - "block-customer-modal.tsx"
Cohesion: 0.50
Nodes (3): BlockCustomerModal, BlockCustomerModal(), BlockCustomerModalProps

## Knowledge Gaps
- **4710 isolated node(s):** `$schema`, `style`, `rsc`, `tsx`, `config` (+4705 more)
...
- **Why does `delete` connect `admin_extended.py` to `Category`, `User`, `Restaurant`, `fastapi-backend/routers/products.py`, `fastapi-backend/routers/addresses.py`, `Order`, `fastapi-backend/routers/cart.py`, `secure_storage_service.dart`, `app/routers/addresses.py`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `Product` connect `admin_extended.py` to `get_ai_demand_forecast`, `Order`, `models.py`, `Category`, `Restaurant`, `get_buy_again_products`, `fastapi-backend/routers/products.py`, `User`, `fastapi-backend/routers/cart.py`?**
