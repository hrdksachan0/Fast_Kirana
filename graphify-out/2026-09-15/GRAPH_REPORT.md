...
## Corpus Check
- 866 files · ~3,242,202 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8214 nodes · 14362 edges · 404 communities (331 shown, 73 thin omitted)
...
## Communities (404 total, 73 thin omitted)

### Community 0 - "package:flutter/material.dart"
Cohesion: 0.03
Nodes (84): ../cafe/restaurant_dashboard.dart, ../core/theme/design_system.dart, delivery_dashboard.dart, AboutScreen, build, _divider, _linkItem, _statBox (+76 more)
...
Cohesion: 0.04
Nodes (62): GET(), PATCH(), POST(), PUT(), DELETE(), GET(), PATCH(), POST() (+54 more)
...
### Community 5 - "cn"
Cohesion: 0.04
Nodes (64): EditRestaurantPage(), getRoleRedirect(), LoginForm(), RootLayout(), AccountDashboardProps, WishlistClient(), WishlistItem, RestaurantForm() (+56 more)
...
Cohesion: 0.06
Nodes (37): CUISINES, FoodMarketplace(), FoodMarketplaceProps, SortOption, DeliveryBanner(), EDITORIAL_BANNERS, FoodEditorialCuration(), GOURMET_CATEGORIES (+29 more)
...
### Community 10 - "revalidateStorefront"
Cohesion: 0.09
Nodes (27): DELETE(), GET(), POST(), PUT(), computeNewValue(), DELETE(), generateBatchId(), GET() (+19 more)
...
Cohesion: 0.05
Nodes (40): empty_state.dart, widgets, _buildFilterPill, createState, _cuisineCategories, dispose, _searchController, _buildShimmerGrid (+32 more)
...
Cohesion: 0.08
Nodes (24): _buildEmptyState, _buildSearchBox, _buildSegmentedTabs, _buildStatusFilterPills, createState, dispose, OrderCardSkeleton, primaryRed (+16 more)

### Community 15 - "constants.ts"
Cohesion: 0.05
Nodes (49): AdminBulkUpdate(), AdminBulkUpdateProps, BatchHistory, Category, ChangePreview, Product, AdminRestaurantConsole(), AdminRestaurantConsoleProps (+41 more)

### Community 16 - "package:flutter_riverpod/flutter_riverpod.dart"
Cohesion: 0.03
Nodes (77): ../core/services/location_service.dart, ../data/models/address.dart, LocationDetails, autoFetchLocation, _checkAndAutoPromptLocation, createState, dispose, _getAddressIcon (+69 more)
...
### Community 23 - "auth"
Cohesion: 0.04
Nodes (61): WishlistPage(), AdminPage(), revalidate, NewRestaurantPage(), DELETE(), dynamic, GET(), POST() (+53 more)

### Community 24 - "api/products/route.ts"
Cohesion: 0.07
Nodes (36): GET(), GET(), GET(), getFuzzyScore(), getLevenshteinDistance(), SYNONYM_DICTIONARY, DEFAULT_CAFE_SECTIONS, DEFAULT_RESTAURANT_SECTIONS (+28 more)

### Community 25 - "checkout/page.tsx"
Cohesion: 0.04
Nodes (70): GET(), CheckoutDeliverySelector(), DeliverySelectorProps, CheckoutPage(), CheckoutAddressSectionProps, EmptyCartScreen(), InventoryIssueScreen(), InventoryIssueScreenProps (+62 more)
...
Cohesion: 0.03
Nodes (78): ../categories/category_products_screen.dart, build, build, CategoryProductsScreen, _CategoryProductsScreenState, build, SubcategoryScreen, _SubcategoryScreenState (+70 more)
...
Cohesion: 0.05
Nodes (64): CategoriesScreen, ConsumerState, ConsumerStatefulWidget, DeliveryLoginScreen, AdminLoginScreen, _AdminLoginScreenState, DeliveryLoginScreen, _DeliveryLoginScreenState (+56 more)

### Community 36 - "rider_location_service.dart"
Cohesion: 0.05
Nodes (38): extractRestaurantItems, formatKOTDate, generateKOTPdfDocument, KotPrintService, printKOTReceipt, _recentPrintTimestamps, sendRemoteKOTToKitchen, shareKOTReceipt (+30 more)
...
Cohesion: 0.07
Nodes (29): @auth/prisma-adapter, bcryptjs, class-variance-authority, clsx, framer-motion, libphonenumber-js, nodemailer, dependencies (+21 more)

### Community 40 - "delivery_dashboard.dart"
Cohesion: 0.02
Nodes (103): ../../core/services/rider_location_service.dart, _activeTab, _assignedStoreId, _assignedStoreName, _audioPlayer, _autoRefreshTimer, bgMain, borderCol (+95 more)

### Community 41 - "api/orders/route.ts"
Cohesion: 0.08
Nodes (44): POST(), POST(), POST(), GET(), POST(), POST(), POST(), DELETE() (+36 more)
...
### Community 43 - "profile_screen.dart"
Cohesion: 0.03
Nodes (58): address_book_screen.dart, ../auth/login_screen.dart, ../cart/cart_screen.dart, ../core/utils/dish_timing.dart, ../../data/repositories/auth_repository.dart, build, _buildTncSection, createState (+50 more)
...
Cohesion: 0.02
Nodes (91): ../../core/network/network_retry_helper.dart, _handleLogout, _handleVerifyOtp, OtpScreen, _OtpScreenState, _activeTab, _assignedRestaurantId, _audioPlayer (+83 more)
...
Cohesion: 0.05
Nodes (41): ../common/order_edit_modal.dart, CachedMapTileProvider, customHeaders, getImage, _autoRefreshTimer, bgMain, brandGreen, brandOrange (+33 more)
...
Cohesion: 0.03
Nodes (75): design_system.dart, _activeBroadcastChannels, broadcastRiderLocation, _client, initialize, _isInitialized, subscribeToAllOrdersRealtime, subscribeToOrderLocation (+67 more)

### Community 63 - "validators.dart"
Cohesion: 0.15
...
Cohesion: 0.06
Nodes (30): AudioPlayer, ../data/models/order.dart, AdminNotificationService, fireAdminWhatsAppAlert, formatOrderWhatsAppMessage, formatRestaurantKOTMessage, sendSubstitutionWhatsApp, _auth (+22 more)
...
Cohesion: 0.03
Nodes (75): dynamic, revalidate, CategoryPage(), CategoryPageProps, revalidate, CheckoutOrderSummary(), OrderSummaryProps, getCachedAllGroceryProducts (+67 more)
...
Cohesion: 0.05
Nodes (37): area, baseFee, bootstrapUserLocation, cart, checkLocationDriftAndPrompt, city, deliveryFee, DeliveryTierInfo (+29 more)

### Community 79 - "category_products_screen.dart"
Cohesion: 0.04
Nodes (61): category_products_screen.dart, ../core/routes/page_transitions.dart, ../../core/widgets/loading_widgets.dart, ../data/models/category.dart, ../data/models/product.dart, ../data/repositories/product_repository.dart, build, _categories (+53 more)

### Community 80 - "checkout_screen.dart"
Cohesion: 0.03
Nodes (61): CFPaymentGatewayService, ../checkout/order_success_screen.dart, ../../core/services/kot_print_service.dart, brandGreen, _buildBillRow, _buildBillSummary, _buildBottomProceedBar, _buildCartItemsReview (+53 more)
...
### Community 90 - "order_repository.dart"
Cohesion: 0.04
Nodes (49): ../../core/services/admin_authorization.dart, dart:convert, dart:io, BatteryOptimizationService, markDismissed, _prefKeyDismissed, requestExemption, shouldShowPrompt (+41 more)
...
### Community 94 - "restaurant_delivery_loading_screen.dart"
Cohesion: 0.11
...
Cohesion: 0.03
Nodes (59): _activeCategoryTag, _buildCategories, _buildCategoryThumbnail, _buildDishImage, _buildFallbackBanner, _buildFallbackLogo, _buildLocalAssetOrEmoji, _buildLogoWidget (+51 more)
...
Cohesion: 0.05
Nodes (43): ../core/network/api_client.dart, ../data/models/store_settings.dart, ../data/repositories/coupon_repository.dart, ../data/repositories/wishlist_repository.dart, Dio, AuthRepository, dio, getProfile (+35 more)

### Community 100 - "admin-dashboard.tsx"
Cohesion: 0.05
Nodes (41): AdminAlerts(), AdminDashboard(), AdminDashboardProps, MediaLibraryModal, TabType, AlertsTab(), AlertsTabProps, CategoriesTab() (+33 more)
...
Cohesion: 0.08
Nodes (29): build, OrderTrackingScreen, _OrderTrackingScreenState, bannersProvider, _advanceToNext, _autoSlideTimer, build, _buildBannerCard (+21 more)

### Community 103 - "cartProvider"
Cohesion: 0.05
Nodes (57): ConsumerWidget, FadeSlideRoute, deliveryTierProvider, _loadSettings, _buildAdminOrderCard, _buildDishAddButton, _buildMenuTab, _buildRestaurantDishItem (+49 more)
...
Cohesion: 0.06
Nodes (29): cart_conflict_dialog.dart, ../core/config/app_config.dart, ../data/models/restaurant.dart, AppUpdateDialog, build, checkAndShow, _handleUpdate, _hasPromptedThisSession (+21 more)
...
Cohesion: 0.05
Nodes (94): POST(), CartPage(), Error(), jakarta, metadata, viewport, CartConflictDialog(), CartDrawer() (+86 more)
...
### Community 117 - "_SearchScreenState"
Cohesion: 0.18
Nodes (11): _buildFoodRestaurantListing, _buildPayOnlineCard, _buildReviewCard, build, build, _buildSearchResults, SearchScreen, _SearchScreenState (+3 more)
...
### Community 132 - "dart:async"
Cohesion: 0.05
Nodes (40): address_provider.dart, cart_provider.dart, core/routes/app_router.dart, core/services/deep_link_service.dart, ../core/services/notification_service.dart, ../core/services/secure_storage_service.dart, ../core/services/supabase_service.dart, core/theme/app_theme.dart (+32 more)
...
### Community 140 - "splash/splash_screen.dart"
Cohesion: 0.09
...
Cohesion: 0.13
Nodes (20): AdminRestaurantsPage(), revalidate, GET(), checkAdmin(), GET(), PATCH(), POST(), GET() (+12 more)
...
Cohesion: 0.07
Nodes (41): ../data/repositories/restaurant_repository.dart, build, build, build, _buildDarkstoreRecommendationsSection, CafeMenuScreen, _CafeMenuScreenState, _centerCategoryInHorizontalBar (+33 more)
...
Cohesion: 0.06
Nodes (30): ../../../core/utils/app_toast.dart, ../core/utils/restaurant_utils.dart, _adminCatalogFilter, _buildAdminFilterChip, _buildCatalogSearchTab, _buildCustomItemTab, createState, _customNameController (+22 more)
...
### Community 185 - "get_buy_again_products"
Cohesion: 0.17
...
Cohesion: 0.04
Nodes (52): ../admin/admin_dashboard.dart, ../data/models/user.dart, ../delivery/delivery_dashboard.dart, build, createState, dispose, _emailController, _errorMessage (+44 more)
...
### Community 254 - "location-picker.tsx"
Cohesion: 0.17
...
### Community 294 - "grocery_delivery_loading_screen.dart"
Cohesion: 0.11
...
### Community 295 - "orders_service.py"
Cohesion: 0.20
...
Cohesion: 0.12
Nodes (15): ../data/repositories/address_repository.dart, AddressRepository, AddressesScreen, _buildAddressCard, addAddress, addressesAsync, addressRepositoryProvider, clear (+7 more)
...
Cohesion: 0.05
Nodes (35): BorderRadius?, Color?, appliedCoupon, build, CartSavingsBanner, couponDiscount, freeDeliveryThreshold, onApplyCouponTap (+27 more)

### Community 314 - "doctor.md"
Cohesion: 0.25
...
Cohesion: 0.02
Nodes (120): BoxShape, DishTimingStatus, double?, EdgeInsets, AppShimmer, build, child, count (+112 more)
...
### Community 328 - "State"
Cohesion: 0.11
Nodes (29): ContextualBrandTransitionScreen, _ContextualBrandTransitionScreenState, SplashScreen, _SplashScreenState, RestaurantDeliveryLoadingScreen, _RestaurantDeliveryLoadingScreenState, RestaurantMenuCatalogTab, _RestaurantMenuCatalogTabState (+21 more)
...
Cohesion: 0.03
Nodes (113): CheckoutCouponInput(), CouponInputProps, ActiveDeliveryCard(), ActiveDeliveryCardProps, itemVariants, CodPaymentModal(), CodPaymentModalProps, ModalStep (+105 more)

### Community 337 - "app/routers/banners.py"
Cohesion: 0.28
Nodes (6): PromoBanner, Base, get_banners(), get, PromoBannerOut, BaseModel

### Community 338 - "banner_provider.dart"
Cohesion: 0.29
...
### Community 347 - "main_shell.dart"
Cohesion: 0.06
Nodes (33): ../categories/categories_screen.dart, ../core/utils/app_connectivity.dart, ../delivery/picker_dashboard.dart, connectivityProvider, _autoShowTimer, createState, didChangeAppLifecycleState, dispose (+25 more)
...
### Community 360 - "category-edit-modal.tsx"
Cohesion: 0.40
...
### Community 383 - "onboarding_screen.dart"
Cohesion: 0.18
...
### Community 390 - "get_ai_demand_forecast"
Cohesion: 0.33
...
- **Why does `dependencies` connect `dependencies` to `fcm.py`, `date-fns`, `package.json`, `@base-ui/react`, `next`, `@prisma/adapter-pg`, `react`, `@types/papaparse`, `@upstash/redis`, `dotenv`, `lru-cache`, `next-auth`, `pg`, `sharp`, `sonner`, `papaparse`, `@tailwindcss/postcss`, `@supabase/supabase-js`, `tailwind-merge`, `tailwindcss`, `lucide-react`, `@types/pg`, `@types/react`, `prisma`, `@types/react-dom`, `resend`, `@types/web-push`, `web-push`, `xlsx`, `zustand`?**
...
- **Should `package:flutter/material.dart` be split into smaller, more focused modules?**
  _Cohesion score 0.026415094339622643 - nodes in this community are weakly interconnected._
...
- **Should `prisma.ts` be split into smaller, more focused modules?**
  _Cohesion score 0.04205607476635514 - nodes in this community are weakly interconnected._
