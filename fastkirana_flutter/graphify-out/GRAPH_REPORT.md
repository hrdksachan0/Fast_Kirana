# Graph Report - fastkirana_flutter  (2026-09-23)

## Corpus Check
- 340 files · ~764,553 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5268 nodes · 8488 edges · 217 communities (213 shown, 4 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5f4f158a`
...
1. `dioProvider` - 104 edges
2. `cartProvider` - 52 edges
3. `FadeSlideRoute` - 36 edges
4. `authProvider` - 36 edges
...
Cohesion: 0.03
Nodes (77): ../../core/network/network_retry_helper.dart, _activeTab, _assignedRestaurantId, _audioPlayer, _autoRefreshTimer, bgMain, brandAmber, brandGreen (+69 more)
...
Cohesion: 0.06
Nodes (30): build, createState, dispose, _homeScrollController, _isGrocerySelected, _isLoadingMoreGrid, _onHomeScroll, _orderSyncTimer (+22 more)
...
Cohesion: 0.03
Nodes (65): ../features/products/product_detail_screen.dart, Gradient, _addButton, bestseller, bogo, bogoBadgeText, child, createState (+57 more)
...
Cohesion: 0.04
Nodes (53): cafe_menu_screen.dart, GlobalKey, _activeCategoryTag, _buildCategories, _buildCategoryThumbnail, _buildFallbackBanner, _buildFallbackLogo, _buildLocalAssetOrEmoji (+45 more)
...
Cohesion: 0.08
Nodes (24): double get, appliedCouponCode, Cart, cartId, copyWith, couponDiscount, createdAt, fromJson (+16 more)
...
Cohesion: 0.09
Nodes (21): ProductRepository, activeOutlet, activeRestaurantId, all, cart, cartItems, cleanIds, filteredUpsells (+13 more)

### Community 18 - "cartProvider"
Cohesion: 0.07
Nodes (38): ConsumerWidget, ../data/models/cart.dart, AdminOrderCard, build, _buildCartErrorState, CartBottomCheckoutBar, build, CartCrossSellSheet (+30 more)
...
Cohesion: 0.09
Nodes (21): ../../features/admin/vendor_console_screen.dart, ../../features/auth/admin_login.dart, ../../features/auth/delivery_login.dart, ../../features/auth/login_screen.dart, ../../features/auth/otp_screen.dart, ../../features/auth/vendor_login.dart, ../../features/cafe/restaurant_dashboard.dart, ../../features/categories/categories_screen.dart (+13 more)

### Community 22 - "main_shell.dart"
Cohesion: 0.13
Nodes (18): ../categories/categories_screen.dart, home_screen.dart, build, _buildLiquidBottomNav, createState, didChangeAppLifecycleState, dispose, initState (+10 more)
...
### Community 26 - "../core/routes/page_transitions.dart"
Cohesion: 0.09
Nodes (24): ../../cafe/cafe_menu_screen.dart, ../core/routes/page_transitions.dart, curated_brand_offer_card.dart, ../data/models/banner.dart, ../data/models/brand_offer_card_data.dart, ../data/models/restaurant.dart, ../data/repositories/banner_repository.dart, ../features/cafe/cafe_menu_screen.dart (+16 more)

### Community 27 - "checkout_delivery_instructions.dart"
Cohesion: 0.07
Nodes (27): build, CartCancellationPolicy, CartDeliveryInstructions, CartTipSelector, _instructions, onTipSelected, onToggleInstruction, selectedInstructions (+19 more)
...
Cohesion: 0.04
Nodes (55): ../../core/services/admin_authorization.dart, ../core/theme/design_system.dart, AdminBannersScreen, build, AdminCustomersScreen, build, AdminRefundSheet, show (+47 more)

### Community 30 - "category_products_screen.dart"
Cohesion: 0.05
Nodes (38): ../../core/widgets/loading_widgets.dart, ../data/models/product.dart, ../data/repositories/product_repository.dart, FocusNode, _buildFilterPill, category, createState, dispose (+30 more)

### Community 31 - "widgets.dart"
Cohesion: 0.09
Nodes (21): app_cached_image.dart, empty_state.dart, widgets, _buildFilterPill, createState, _cuisineCategories, dispose, RestaurantsListScreen (+13 more)

### Community 32 - "StatelessWidget"
Cohesion: 0.08
Nodes (30): build, order, TrackingDestinationCard, TrackingReceiptCard, TrackingRefundNoticeCard, build, CartShimmerSkeleton, CategoryBentoSkeleton (+22 more)
...
Cohesion: 0.12
Nodes (17): ../core/utils/dish_timing.dart, ProductVariant, _addToCart, _buildCustomizedProduct, _buildQualityRow, createState, initState, _isFavorite (+9 more)
...
### Community 45 - "../core/network/api_client.dart"
Cohesion: 0.09
Nodes (22): ../core/network/api_client.dart, ../data/repositories/wishlist_repository.dart, Dio, dio, getCoupons, addToWishlist, dio, getWishlist (+14 more)

### Community 46 - "api_client.dart"
Cohesion: 0.08
Nodes (22): Completer, int?, dio, _isRefreshingToken, kNetworkRetryDelays, message, null, _refreshCompleter (+14 more)
...
### Community 59 - "curated_brand_offer_card.dart"
Cohesion: 0.04
...
Cohesion: 0.13
Nodes (21): ../data/models/address.dart, build, _handleSaveAddress, _handleSaveAddress, AddressBookScreen, _AddressBookScreenState, build, _buildEmptyState (+13 more)

### Community 61 - "authProvider"
Cohesion: 0.10
Nodes (21): ../data/models/user.dart, ../../../data/repositories/auth_repository.dart, _handleLogout, _handleVerifyOtp, build, _initOutletDetails, _resolveOutletDetailsSync, _showKOTPrintModal (+13 more)

### Community 62 - "vendor_console_screen.dart"
Cohesion: 0.04
Nodes (49): brandGreen, brandOrange, build, _buildEmptyVendorsView, _buildFinancialKPIBanner, _buildKPIColumn, _buildLiveOrdersTab, _buildPayoutsTab (+41 more)
...
Cohesion: 0.10
Nodes (18): ../../../core/utils/order_item_helper.dart, ../../../core/utils/validators.dart, build, DeliveryOrderDetailScreen, orderId, badgeId, build, _buildStoreGroupCard (+10 more)
...
Cohesion: 0.09
Nodes (22): ../core/services/location_service.dart, ../features/cart/cart_screen.dart, DeliveryTierInfo, build, CartFreeDeliveryBar, subtotal, tier, build (+14 more)
...
Cohesion: 0.07
Nodes (29): package:fastkirana_flutter/core/network/api_client.dart, package:fastkirana_flutter/core/services/biometric_service.dart, package:fastkirana_flutter/core/services/offline_sync_service.dart, package:fastkirana_flutter/core/services/secure_storage_service.dart, package:fastkirana_flutter/data/models/order.dart, package:fastkirana_flutter/data/models/restaurant.dart, package:fastkirana_flutter/data/models/user.dart, package:fastkirana_flutter/features/delivery/widgets/connectivity_banner.dart (+21 more)

### Community 75 - "order_tracking_screen.dart"
Cohesion: 0.02
Nodes (80): BitmapDescriptor?, GoogleMapController?, _audioPlayer, brandGreen, build, _calculateBearing, _calculateETA, _cfService (+72 more)
...
### Community 77 - "address_selector_sheet.dart"
Cohesion: 0.16
...
Cohesion: 0.07
Nodes (28): class, _barcodeController, brandGreen, brandOrange, build, _commonUnits, createState, _descriptionController (+20 more)
...
Cohesion: 0.07
Nodes (31): ../data/models/store_settings.dart, FadeSlideRoute, _loadSettings, build, _handleContinue, _buildMenuTab, _proceedToCheckout, build (+23 more)
...
### Community 117 - "loading_widgets.dart"
Cohesion: 0.14
Nodes (12): buildWeightBadge, OrderItemHelper, resolveWeightOrVariant, AppShimmer, build, child, count, OrderCardShimmer (+4 more)

### Community 118 - "_MapPickerScreenState"
Cohesion: 0.40
...
### Community 122 - "checkout_controller.dart"
Cohesion: 0.04
Nodes (49): CFPaymentGatewayService, _cfService, completeOrderPlacement, _cookingInstruction, copyWith, _couponCode, _currentContext, _customDeliveryNotes (+41 more)
...
Cohesion: 0.08
Nodes (25): CartRepository, package:dio/dio.dart, package:fastkirana_flutter/core/utils/restaurant_utils.dart, package:fastkirana_flutter/data/models/cart.dart, package:fastkirana_flutter/data/models/product.dart, package:fastkirana_flutter/data/models/store_hub.dart, package:fastkirana_flutter/data/repositories/cart_repository.dart, package:fastkirana_flutter/features/checkout/controllers/checkout_controller.dart (+17 more)

### Community 125 - "selectedAddressProvider"
Cohesion: 0.12
Nodes (19): bootstrapUserLocation, checkLocationDriftAndPrompt, LocationDetails, LocationService, CheckoutController, CheckoutState, initState, build (+11 more)

### Community 126 - "app_toast.dart"
Cohesion: 0.10
Nodes (19): AppToast, build, createState, _currentOverlay, _dismissTimer, _fallbackSnackBar, _isExiting, onDismiss (+11 more)

### Community 127 - "brand_offer_card_data.dart"
Cohesion: 0.05
...
Cohesion: 0.11
Nodes (37): CategoriesScreen, ConsumerState, ConsumerStatefulWidget, AdminProductsScreen, _AdminProductsScreenState, build, AddRestaurantProductModal, _AddRestaurantProductModalState (+29 more)
...
### Community 135 - "card_color_palette.dart"
Cohesion: 0.06
...
### Community 143 - "TextEditingController"
Cohesion: 0.15
...
### Community 146 - "home_product_sections.dart"
Cohesion: 0.05
Nodes (41): ../../categories/category_products_screen.dart, category_products_screen.dart, ../data/models/category.dart, home_end_of_aisle_search_card.dart, _categories, CategoriesScreen, build, _buildReferenceCategoryCard (+33 more)
...
Cohesion: 0.12
Nodes (15): ../../../../core/services/kot_print_service.dart, ../../core/services/logger_service.dart, ../../../core/utils/app_toast.dart, formatKitchenWhatsAppMessage, generateKOTText, ITEM, RestaurantKotModal, show (+7 more)

### Community 149 - "package:flutter_riverpod/flutter_riverpod.dart"
Cohesion: 0.06
Nodes (36): address_book_screen.dart, build, HomeBuyAgainShelf, isGrocerySelected, ordersProvider, build, _buildSectionHeader, primaryRed (+28 more)
...
Cohesion: 0.11
Nodes (15): build, couponId, createState, _infoRow, _isActive, build, RestaurantOrderQueueScreen, build (+7 more)

### Community 160 - "card_media_widget.dart"
Cohesion: 0.07
...
### Community 161 - "edit_picker_product_modal.dart"
Cohesion: 0.07
Nodes (27): FormState, brandGreen, brandOrange, build, _calculateDiscount, createState, dispose, EditPickerProductModal (+19 more)
...
Cohesion: 0.08
Nodes (22): ../../../core/services/battery_optimization_service.dart, CartItem, RestaurantPrepTimeModal, show, build, CartItemCard, item, onDecrement (+14 more)
...
### Community 165 - "Color"
Cohesion: 0.11
Nodes (17): Color, appliedCoupon, build, CartSavingsBanner, couponDiscount, freeDeliveryThreshold, onApplyCouponTap, onRemoveCouponTap (+9 more)

### Community 166 - "cart_bottom_checkout_bar.dart"
Cohesion: 0.17
Nodes (11): cart_cross_sell_sheet.dart, appliedCoupon, build, cookingInstruction, couponDiscount, deliveryFee, grandTotal, onViewBreakdown (+3 more)

### Community 167 - "home_top_header.dart"
Cohesion: 0.18
...
### Community 170 - "profile_menu_item.dart"
Cohesion: 0.18
Nodes (10): badge, badgeColor, build, icon, iconBg, iconColor, onTap, ProfileMenuItem (+2 more)
...
### Community 172 - "app_cached_image.dart"
Cohesion: 0.10
...
Cohesion: 0.08
Nodes (26): ../core/utils/restaurant_utils.dart, ../../../core/widgets/app_cached_image.dart, CachedMapTileProvider, customHeaders, getImage, build, _buildCookingInstructions, CartItemsSection (+18 more)

### Community 177 - "../data/models/order.dart"
Cohesion: 0.05
Nodes (38): @JsonSerializable, ../core/config/app_config.dart, ../../core/services/admin_notification_service.dart, ../core/theme/responsive.dart, ../data/models/order.dart, _, Order, OrderItem (+30 more)
...
Cohesion: 0.06
Nodes (32): dart:convert, dart:io, AdminNotificationService, fireAdminWhatsAppAlert, formatOrderWhatsAppMessage, formatRestaurantKOTMessage, sendSubstitutionWhatsApp, BatteryOptimizationService (+24 more)
...
### Community 181 - "profile_header_card.dart"
Cohesion: 0.20
Nodes (9): ../../auth/login_screen.dart, build, _buildGuestHeader, _buildUserHeader, name, onEditProfile, phoneDisplay, ProfileHeaderCard (+1 more)

### Community 182 - "restaurant_settings_tab.dart"
Cohesion: 0.29
Nodes (6): build, isBusyMode, isStoreOpen, onToggleBusyMode, onToggleStoreOpen, RestaurantSettingsTab
...
### Community 189 - "checkout_delivery_address_card.dart"
Cohesion: 0.22
Nodes (8): Address?, _Address, build, CheckoutDeliveryAddressCard, onAddressChanged, selectedAddress, tier, ../../../widgets/address_selector_sheet.dart
...
### Community 193 - "retry_wrapper.dart"
Cohesion: 0.22
Nodes (8): build, child, error, isLoading, onRetry, retryLabel, RetryWrapper, Object?

### Community 194 - "dart:math"
Cohesion: 0.12
Nodes (15): dart:math, bestTokenFuzzyDistance, damerauLevenshtein, FuzzyMatcher, isFuzzyMatch, similarityScore, adaptiveJitterThreshold, calculateBearing (+7 more)

### Community 195 - "picker_catalog_browser_modal.dart"
Cohesion: 0.11
...
### Community 196 - "hub_waitlist_sheet.dart"
Cohesion: 0.12
...
Cohesion: 0.10
Nodes (15): package:fastkirana_flutter/core/config/app_config.dart, package:fastkirana_flutter/core/services/location_service.dart, package:fastkirana_flutter/core/utils/fuzzy_matcher.dart, package:fastkirana_flutter/data/models/store_settings.dart, package:fastkirana_flutter/features/admin/widgets/admin_stats_grid.dart, package:fastkirana_flutter/features/cart/widgets/cart_bill_details_card.dart, package:fastkirana_flutter/features/cart/widgets/cart_free_delivery_bar.dart, package:fastkirana_flutter/features/checkout/widgets/checkout_bottom_bar.dart (+7 more)

### Community 198 - "shimmer_box.dart"
Cohesion: 0.12
Nodes (16): BoxShape, double?, BannerSkeleton, borderRadius, build, CategorySkeleton, _controller, createState (+8 more)

### Community 199 - "outside_delivery_zone_view.dart"
Cohesion: 0.16
Nodes (13): ../data/models/store_hub.dart, hub_waitlist_sheet.dart, StoreHub, build, _buildFeaturePill, hub, HubComingSoonView, build (+5 more)

### Community 200 - "vendor_login.dart"
Cohesion: 0.14
Nodes (14): ../core/services/secure_storage_service.dart, build, createState, dispose, _errorMessage, _handleVendorLogin, _isLoading, _phoneOrCodeController (+6 more)

### Community 201 - "picker_scan_screen.dart"
Cohesion: 0.14
...
Cohesion: 0.08
Nodes (24): ../../checkout/checkout_screen.dart, ProductRestaurantExtension, Product, CartCelebrationModal, show, appliedCoupon, cartProductIds, cookingInstruction (+16 more)

### Community 207 - "floating_order_tracking_bar.dart"
Cohesion: 0.18
...
### Community 208 - "profile_quick_stats.dart"
Cohesion: 0.18
Nodes (10): addressesCount, build, _buildShortcutCard, isLoggedIn, onAddressesTap, onOrdersTap, onWishlistTap, ordersCount (+2 more)

### Community 209 - "checkout_receiver_card.dart"
Cohesion: 0.29
Nodes (6): build, CheckoutReceiverCard, customerName, customerPhone, isOrderingForSomeone, _showEditReceiverModal

### Community 210 - "about_screen.dart"
Cohesion: 0.33
Nodes (5): AboutScreen, build, _divider, _linkItem, _statBox

### Community 211 - "admin_settings.dart"
Cohesion: 0.40
Nodes (4): AdminSettingsScreen, build, _divider, _switchTile

### Community 213 - "curated_brand_offer_card_test.dart"
Cohesion: 0.29
Nodes (6): package:fastkirana_flutter/data/models/brand_offer_card_data.dart, package:fastkirana_flutter/providers/banner_provider.dart, package:fastkirana_flutter/widgets/card_media_widget.dart, package:fastkirana_flutter/widgets/curated_brand_offer_card.dart, package:fastkirana_flutter/widgets/dynamic_hero_banner_carousel.dart, main

### Community 215 - "admin_reports.dart"
Cohesion: 0.33
Nodes (5): AdminReportsScreen, _breakdownRow, build, _reportStat, _topRow

### Community 217 - "State"
Cohesion: 0.12
Nodes (26): _GenZTopToastWidget, _GenZTopToastWidgetState, AdminCouponsDetailScreen, _AdminCouponsDetailScreenState, SplashScreen, _SplashScreenState, PaymentFailedCodSheet, _PaymentFailedCodSheetState (+18 more)

## Knowledge Gaps
- **3701 isolated node(s):** `AppConfig`, `primaryApiUrl`, `secondaryApiUrl`, `apiBaseUrl`, `webStorefrontUrl` (+3696 more)
...
- **Why does `dioProvider` connect `dioProvider` to `restaurant_dashboard.dart`, `ConsumerState`, `doorstep_cashfree_qr_sheet.dart`, `add_review_screen.dart`, `cart_screen.dart`, `cartProvider`, `package:flutter_riverpod/flutter_riverpod.dart`, `main_shell.dart`, `otp_screen.dart`, `package:flutter/material.dart`, `admin_orders_list.dart`, `auth/delivery_login.dart`, `edit_picker_product_modal.dart`, `login_screen.dart`, `api_client.dart`, `order_success_screen.dart`, `admin_products.dart`, `notifications_screen.dart`, `admin_login.dart`, `delivery_dashboard.dart`, `authProvider`, `vendor_console_screen.dart`, `order_edit_modal.dart`, `admin_dashboard.dart`, `picker_catalog_browser_modal.dart`, `hub_waitlist_sheet.dart`, `vendor_login.dart`, `floating_order_tracking_bar.dart`, `picker_dashboard.dart`, `_VendorConsoleScreenState`, `add_picker_product_modal.dart`, `add_restaurant_product_modal.dart`, `FadeSlideRoute`, `selectedAddressProvider`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Why does `_SearchScreenState` connect `ConsumerState` to `cartProvider`, `search_screen.dart`, `FadeSlideRoute`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Why does `Product` connect `package:flutter/services.dart` to `product_detail_screen.dart`, `product.dart`, `variant_selector_sheet.dart`, `product_card.dart`, `models/cart.dart`, `../core/utils/restaurant_utils.dart`, `admin_products.dart`?**
