...
export async function GET(request: NextRequest) {
  try {
        ...
        where: {
          key: {
            in: [
              ...
              'delivery_fee',
              'delivery_fee_tier1',
              'delivery_threshold_tier1',
              'delivery_fee_tier2',
              'delivery_threshold_tier2',
              'delivery_fee_tier3',
              'delivery_threshold_tier3',
              'delivery_fee_per_km_beyond_5km',
    ...
    const payload = {
      ...
      delivery_radius: settingsMap['delivery_radius'] || '5.0',
      delivery_fee: settingsMap['delivery_fee'] || '25',
      delivery_fee_tier1: settingsMap['delivery_fee_tier1'] || '25',
      delivery_threshold_tier1: settingsMap['delivery_threshold_tier1'] || '199',
      delivery_fee_tier2: settingsMap['delivery_fee_tier2'] || '35',
      delivery_threshold_tier2: settingsMap['delivery_threshold_tier2'] || '299',
      delivery_fee_tier3: settingsMap['delivery_fee_tier3'] || '50',
      delivery_threshold_tier3: settingsMap['delivery_threshold_tier3'] || '399',
      delivery_fee_per_km_beyond_5km: settingsMap['delivery_fee_per_km_beyond_5km'] || '10',
      grocery_free_delivery_threshold: settingsMap['grocery_free_delivery_threshold'] || '199',
      cafe_free_delivery_threshold: settingsMap['cafe_free_delivery_threshold'] || '199',
      combined_free_delivery_threshold: settingsMap['combined_free_delivery_threshold'] || '199',
      misc_fee: settingsMap['misc_fee'] || '0',
      misc_fee_label: settingsMap['misc_fee_label'] || 'Miscellaneous Additions',
