...
export function CategoriesDirectoryClient({ categories }: CategoriesDirectoryClientProps) {
  ...
  const categoryConfigs: Record<string, CategoryConfig> = {
    ...
    'beverages': {
      ...
      borderColor: 'border-zinc-150 dark:border-zinc-800/40',
      labelColor: 'text-[#0891B2] dark:text-cyan-400',
      cardBg: 'bg-white dark:bg-zinc-950',
      tagline: 'Soft Drinks & Coolers',
      tagBg: 'bg-cyan-500/[0.03] dark:bg-cyan-950/20 text-cyan-850 dark:text-cyan-300',
      tagHover: 'hover:border-cyan-450 dark:hover:border-cyan-700 hover:bg-cyan-500/[0.08]',
      badgeText: 'Beverages',
      badgeBg: 'bg-[#ECFEFF] text-[#0891B2] dark:bg-cyan-950/40 dark:text-cyan-350',
      badgeIcon: Coffee,
      glowColor: 'hover:shadow-[0_12px_24px_rgba(8,145,178,0.04)]',
      btnBg: 'bg-[#0891B2] hover:bg-[#0E7490]',
      btnArrowColor: 'text-[#0891B2]',
      bgEmoji: '🥤',
    },
    'personal-care': {
      title: 'Personal Care',
