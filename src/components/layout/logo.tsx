  ...
  return (
    <div className={`flex items-center gap-2 select-none ${className}`}>
      ...
      >
        ...
        {/* Clean bold italic sans-serif block F */}
        <path
      ...
      {showText && (
        <div className="flex flex-col text-left leading-none">
          <span className="text-xl font-black italic tracking-tight text-[#e20a22]">
            FastKirana
          </span>
          <div className="flex items-center mt-0.5">
            ...
            <span className={`text-[10px] font-extrabold tracking-wide uppercase ${lightMode ? 'text-gray-300' : 'text-[#00b140]'}`}>
              Delivery App
            </span>
          </div>
        </div>
