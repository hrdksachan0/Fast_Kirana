...
export function StorefrontClient({
  ...
  return (
    <div className="w-full min-h-screen bg-[#fafafa] dark:bg-[#09090b] pb-28 md:pb-12 mt-3 relative">
      ...
      <div className="sticky top-[91px] md:top-[64px] z-40 bg-[#fafafa]/95 dark:bg-[#09090b]/95 backdrop-blur-xl py-1.5 px-4 flex justify-center transition-all duration-300 border-b border-zinc-200/40 dark:border-zinc-800/40 shadow-xs mb-3 sm:mb-4">
