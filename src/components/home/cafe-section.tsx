        ...
        <>
          ...
          <div className="flex flex-row items-start w-full gap-2.5 sm:gap-5 mt-2">
            ...
            <aside 
              ...
              className="sticky top-[66px] md:top-[66px] z-30 w-[76px] min-[375px]:w-[84px] sm:w-[105px] md:w-[190px] shrink-0 max-h-[calc(100vh-145px)] overflow-y-auto scrollbar-none py-1 pb-28 space-y-1.5 select-none border-r border-zinc-200/60 dark:border-zinc-800/60 pr-1.5 sm:pr-2 self-start transition-all duration-300"
            >
