...
import { KdsActivePrepView } from '@/components/admin/kitchen/kds-active-prep-view'
  ...
  if (activeOrder) {
    return (
      <KdsActivePrepView
        ...
        printKOTReceipt={printKOTReceipt}
        autoPackOrder={autoPackOrder}
        scanInput={scanInput}
        setScanInput={setScanInput}
        scanInputRef={scanInputRef}
        handleScanSubmit={handleScanSubmit}
        handleManualPrepareOne={handleManualPrepareOne}
        handleManualPrepareAll={handleManualPrepareAll}
